...
})(), (self.webpackChunkmoey = self.webpackChunkmoey || []).push([
    [95], {
        8095: (K, v, c) => {
            "use strict";
            c.r(v), c.d(v, {
            ...
            let pt = (() => {
                ...
                Ft = (() => {
                    ...
                    return n.\u0275fac = function() {
                        ...
                        hostAttrs: [1, "moey-room-hotpoints"],
                        inputs: {
                            observed: "observed"
                        },
                        standalone: !0,
                        ...
                        styles: [".moey-room-hotpoints{display:flex;position:fixed;opacity:.5;pointer-events:none}\n"],
                        encapsulation: 2,
                        changeDetection: 0
                    }), n
                })();
            ...
            let Vt = (() => {
                ...
                return n.\u0275fac = function(e) {
                    ...
                    vars: 1,
                    consts: [
                        ["class", "moey-caption moey-hotpoint-label regular", 3, "click", 4, "ngIf"],
                        [1, "moey-hotpoint-pin", 3, "click"],
                        [1, "moey-hotpoint-pin-inner"],
                        [1, "moey-hotpoint-pin-center"],
                        [1, "moey-caption", "moey-hotpoint-label", "regular", 3, "click"]
                    ],
                    template: function(e, o) {
                    ...
                    styles: ['[_nghost-%COMP%]{position:absolute;display:flex;flex-direction:column;align-items:center;pointer-events:all;-webkit-tap-highlight-color:rgba(0,0,0,0)}.selected[_nghost-%COMP%]   .moey-hotpoint-pin[_ngcontent-%COMP%]   .moey-hotpoint-pin-inner[_ngcontent-%COMP%]{background:var(--fl-primary)!important;width:24px;height:24px;-webkit-backdrop-filter:unset;backdrop-filter:unset}.selected[_nghost-%COMP%]   .moey-hotpoint-pin[_ngcontent-%COMP%]   .moey-hotpoint-pin-center[_ngcontent-%COMP%]{box-shadow:0 0 23px 3px var(--fl-primary300)}.all-selected[_nghost-%COMP%]   .moey-hotpoint-label[_ngcontent-%COMP%]{background-color:var(--fl-bg)}.all-selected[_nghost-%COMP%]   .moey-hotpoint-label[_ngcontent-%COMP%]:after{background-color:transparent;border-color:var(--fl-bg) transparent transparent transparent}[_nghost-%COMP%]   .moey-hotpoint-pin[_ngcontent-%COMP%]{width:2rem;height:2rem;cursor:pointer;display:flex;justify-content:center;align-items:center;position:relative}[_nghost-%COMP%]   .moey-hotpoint-pin[_ngcontent-%COMP%]:hover   .moey-hotpoint-pin-inner[_ngcontent-%COMP%]{background:rgba(0,0,0,.2)}[_nghost-%COMP%]   .moey-hotpoint-pin[_ngcontent-%COMP%]   .moey-hotpoint-pin-center[_ngcontent-%COMP%]{background-color:var(--fl-bg);width:12px;height:12px;box-shadow:0 0 23px 3px #0000004a;border-radius:50%;position:absolute;inset:0;margin:auto}[_nghost-%COMP%]   .moey-hotpoint-pin[_ngcontent-%COMP%]   .moey-hotpoint-pin-inner[_ngcontent-%COMP%]{width:24px;height:24px;background:rgba(255,255,255,.4);border-radius:50%;-webkit-backdrop-filter:blur(10px);backdrop-filter:blur(10px)}[_nghost-%COMP%]   .moey-hotpoint-label[_ngcontent-%COMP%]{min-height:1.5rem;margin-bottom:8px;padding:.25rem .5rem;cursor:pointer;position:relative;border-radius:var(--fl-border-radius-xs)}[_nghost-%COMP%]   .moey-hotpoint-label[_ngcontent-%COMP%]:after{content:"";background-color:inherit;position:absolute;top:100%;left:50%;margin-left:-5px;border-width:5px;border-style:solid;border-color:transparent transparent transparent transparent}[_nghost-%COMP%]   .moey-hotpoint-label.hidden[_ngcontent-%COMP%]{visibility:hidden;pointer-events:none}'],
                    changeDetection: 0
                }), n
            })();
            var ht = c(5551);
            ...
            function ne(n, l) {
                if (1 & n) {
                    ...
                    }), t.YNc(10, Ut, 2, 1, "span", 12), t.YNc(11, Ot, 3, 3, "span", 12), t._UZ(12, "moey-icon", 13), t.qZA()()()
                }
                if (2 & n) {
                    const e = t.oxw();
            ...
            let ye = (() => {
                ...
                return n.\u0275fac = function(e) {
                    ...
                    vars: 1,
                    consts: [
                        [1, "moey-shoppable-hotpoint", "prevent-select", 3, "click", "mouseenter", "mouseleave"],
                        ["name", "fl_pricetag"],
                        ["class", "moey-shoppable-hotpoint-open", 3, "ngClass", "mouseenter", "mouseleave", 4, "ngIf"],
                        [1, "moey-shoppable-hotpoint-open", 3, "ngClass", "mouseenter", "mouseleave"],
                        [1, "moey-shoppable-hotpoint-data"],
                        ["class", "shoppable-image", 4, "ngIf"],
                        [1, "moey-shoppable-hotpoint-labels"],
                        [1, "shoppable-name"],
                        ["class", "shoppable-price", 4, "ngIf"],
                        ["class", "shoppable-close-button", 3, "click", 4, "ngIf"],
                        [1, "moey-shoppable-hotpoint-actions"],
                    ...
                    template: function(e, o) {
                        ...
                        }), t._UZ(1, "moey-icon", 1), t.qZA(), t.YNc(2, ne, 13, 7, "div", 2)), 2 & e && (t.xp6(2), t.Q6J("ngIf", o.visible))
                    },
                    dependencies: [u.ez, u.mk, u.O5, at.N, rt.X, ht.K],
                    styles: ['[_nghost-%COMP%]{position:absolute;display:flex;flex-direction:column;align-items:center;pointer-events:all}[_nghost-%COMP%]   .moey-shoppable-hotpoint[_ngcontent-%COMP%]{width:1.5rem;height:1.5rem;cursor:pointer;display:flex;justify-content:center;align-items:center;position:relative;padding:.1875rem;border-radius:.5rem;background-color:#000;opacity:.6}[_nghost-%COMP%]   .moey-shoppable-hotpoint[_ngcontent-%COMP%]:hover{opacity:1}[_nghost-%COMP%]   .moey-shoppable-hotpoint[_ngcontent-%COMP%]   moey-icon[_ngcontent-%COMP%]{color:#fff;width:1rem;height:1rem}[_nghost-%COMP%]   .moey-shoppable-hotpoint-open[_ngcontent-%COMP%]{position:absolute;width:200px;border-radius:.5rem;background-color:var(--fl-overlay);display:flex;flex-direction:column;padding:.5rem}[_nghost-%COMP%]   .moey-shoppable-hotpoint-open[_ngcontent-%COMP%]   .moey-shoppable-hotpoint-data[_ngcontent-%COMP%]{display:flex;justify-content:space-between;align-items:center}[_nghost-%COMP%]   .moey-shoppable-hotpoint-open[_ngcontent-%COMP%]   .moey-shoppable-hotpoint-data[_ngcontent-%COMP%]   .shoppable-image[_ngcontent-%COMP%]{width:2.5rem;height:2.5rem;min-width:2.5rem;min-height:2.5rem;border-radius:.25rem;overflow:hidden}[_nghost-%COMP%]   .moey-shoppable-hotpoint-open[_ngcontent-%COMP%]   .moey-shoppable-hotpoint-data[_ngcontent-%COMP%]   .shoppable-image[_ngcontent-%COMP%]   img[_ngcontent-%COMP%]{width:inherit;height:inherit;object-fit:cover}[_nghost-%COMP%]   .moey-shoppable-hotpoint-open[_ngcontent-%COMP%]   .moey-shoppable-hotpoint-data[_ngcontent-%COMP%]   .moey-shoppable-hotpoint-labels[_ngcontent-%COMP%]{width:100%;display:flex;flex-direction:column;color:#fff;margin-left:.5rem;font-weight:600;font-size:.625rem;line-height:.75rem}[_nghost-%COMP%]   .moey-shoppable-hotpoint-open[_ngcontent-%COMP%]   .moey-shoppable-hotpoint-data[_ngcontent-%COMP%]   .moey-shoppable-hotpoint-labels[_ngcontent-%COMP%]   .shoppable-price[_ngcontent-%COMP%]{margin-top:.125rem;opacity:.7}[_nghost-%COMP%]   .moey-shoppable-hotpoint-open[_ngcontent-%COMP%]   .moey-shoppable-hotpoint-data[_ngcontent-%COMP%]   .shoppable-close-button[_ngcontent-%COMP%]{align-self:flex-start;color:#fff}[_nghost-%COMP%]   .moey-shoppable-hotpoint-open[_ngcontent-%COMP%]   .moey-shoppable-hotpoint-actions[_ngcontent-%COMP%]{margin-top:.75rem;display:flex;justify-content:center}[_nghost-%COMP%]   .moey-shoppable-hotpoint-open[_ngcontent-%COMP%]   .moey-shoppable-hotpoint-actions[_ngcontent-%COMP%]   .shoppable-button[_ngcontent-%COMP%]{padding:.25rem .5rem;border-radius:1rem;background-color:var(--fl-overlay);color:#fff;text-transform:capitalize}[_nghost-%COMP%]   .moey-shoppable-hotpoint-open[_ngcontent-%COMP%]   .moey-shoppable-hotpoint-actions[_ngcontent-%COMP%]   .shoppable-button[_ngcontent-%COMP%]   moey-icon[_ngcontent-%COMP%]{margin-left:.5rem;width:1rem;height:1rem}[_nghost-%COMP%]   .moey-shoppable-hotpoint-open[_ngcontent-%COMP%]:after{width:0;height:0;content:"";position:absolute;border-left:.5rem solid transparent;border-right:.5rem solid transparent;border-bottom:.5rem solid var(--fl-overlay)}[_nghost-%COMP%]   .moey-shoppable-hotpoint-open.below[_ngcontent-%COMP%]{top:2.5rem}[_nghost-%COMP%]   .moey-shoppable-hotpoint-open.below[_ngcontent-%COMP%]:after{top:-.5rem;right:calc(50% - .5rem);transform:rotate(0)}[_nghost-%COMP%]   .moey-shoppable-hotpoint-open.above[_ngcontent-%COMP%]{bottom:2.5rem}[_nghost-%COMP%]   .moey-shoppable-hotpoint-open.above[_ngcontent-%COMP%]:after{bottom:-.5rem;right:calc(50% - .5rem);transform:rotate(180deg)}[_nghost-%COMP%]   .moey-shoppable-hotpoint-open.right[_ngcontent-%COMP%]{left:2.5rem;top:50%;transform:translateY(-50%)}[_nghost-%COMP%]   .moey-shoppable-hotpoint-open.right[_ngcontent-%COMP%]:after{left:-.75rem;top:calc(50% - .25rem);transform:rotate(270deg)}[_nghost-%COMP%]   .moey-shoppable-hotpoint-open.left[_ngcontent-%COMP%]{right:2.5rem;top:50%;transform:translateY(-50%)}[_nghost-%COMP%]   .moey-shoppable-hotpoint-open.left[_ngcontent-%COMP%]:after{right:-.75rem;top:calc(50% - .25rem);transform:rotate(90deg)}.prevent-select[_ngcontent-%COMP%]{-webkit-touch-callout:none;-webkit-user-select:none;user-select:none}'],
                    changeDetection: 0
                }), n
            })();
            var Kt = c(5686),
            ...
            function Oe(n, l) {
                if (1 & n) {
                    ...
                    t.ynx(0), t.TgZ(1, "div", 1), t.NdJ("mousedown", function() {
                        ...
                        const r = t.oxw();
                        return t.KtG(r.startCompare())
                    }), t._UZ(2, "moey-icon", 2)(3, "moey-icon", 3), t.qZA(), t.TgZ(4, "div", 4), t._UZ(5, "img", 5, 6), t.qZA(), t.TgZ(7, "div", 7)(8, "div", 8), t._uU(9), t.ALo(10, "flTranslate"), t.qZA(), t.TgZ(11, "div", 9), t._uU(12), t.ALo(13, "flTranslate"), t.qZA()(), t.BQk()
                }
                if (2 & n) {
                    const e = t.oxw();
            ...
            let ft = (() => {
                ...
                return n.\u0275fac = function() {
                    ...
                    hostAttrs: [1, "moey-room-compare"],
                    hostVars: 4,
                    hostBindings: function(e, o) {
                        2 & e && t.ekj("zoomed", o.zoomedCls)
                    },
                    inputs: {
                        canvas: "canvas",
                        image: "image",
                    ...
                    consts: [
                        ...
                        ["id", "before", 1, "compare-label", "moey-caption"],
                        ["id", "after", 1, "compare-label", "moey-caption"]
                    ],
                    template: function(e, o) {
            ...
            let se = (() => {
                ...
                return n.\u0275fac = function(e) {
                    ...
                    hostAttrs: [1, "moey-zoom-tutorial"],
                    standalone: !0,
                    features: [t.jDz],
                    decls: 12,
                    vars: 11,
                    consts: [
                        ...
                        [1, "moey-caption", "tutorial-message"]
                    ],
                    template: function(e, o) {
                        1 & e && (t.TgZ(0, "div", 0), t._UZ(1, "moey-icon", 1)(2, "moey-icon", 2), t.TgZ(3, "div", 3), t._UZ(4, "moey-icon", 4), t.qZA(), t._UZ(5, "moey-icon", 5)(6, "moey-icon", 6), t.qZA(), t.TgZ(7, "p", 7), t._uU(8), t.ALo(9, "flTranslate"), t.ALo(10, "flTranslate"), t.ALo(11, "flTranslate"), t.qZA()), 2 & e && (t.xp6(8), t.hij(" ", t.xi3(9, 1, "room.moveTutorial", t.WLB(8, At, t.lcZ(10, 4, "room.up"), t.lcZ(11, 6, "room.down"))), "\n"))
                    },
                    dependencies: [ht.K, at.N, rt.X],
                    styles: [".moey-zoom-tutorial{border-radius:var(--fl-border-radius);background:var(--fl-overlay);padding:var(--fl-y-padding-md) var(--fl-x-padding-md);color:var(--fl-bg);display:flex;flex-direction:column;justify-content:center;align-items:center}.moey-zoom-tutorial #up-move,.moey-zoom-tutorial #down-move{display:none}.moey-zoom-tutorial .main-icon{width:2rem;height:2rem;margin:0 .25rem;position:relative}.moey-zoom-tutorial .main-icon moey-icon{position:absolute;animation:.5s infinite linear alternate moveHorizontal none}.moey-zoom-tutorial .tutorial-message{margin:var(--fl-x-padding) 0 0;text-align:center}.moey-zoom-tutorial .tutorial-img{display:flex}.moey-zoom-tutorial.vertical{flex-direction:row;align-items:center}.moey-zoom-tutorial.vertical #left-move,.moey-zoom-tutorial.vertical #right-move{display:none}.moey-zoom-tutorial.vertical #up-move,.moey-zoom-tutorial.vertical #down-move{display:initial}.moey-zoom-tutorial.vertical .main-icon{margin:.25rem 0;display:flex;justify-content:center}.moey-zoom-tutorial.vertical .main-icon moey-icon{animation:.5s infinite linear alternate moveVertical none}.moey-zoom-tutorial.vertical .tutorial-img{flex-direction:column;align-items:center}.moey-zoom-tutorial.vertical .tutorial-message{margin:0 0 0 var(--fl-x-padding)}@keyframes moveHorizontal{0%{left:0}to{left:10px}}@keyframes moveVertical{0%{top:0}to{top:10px}}\n"],
                    encapsulation: 2,
                    changeDetection: 0
                }), n
            })();
            ...
            function ae(n, l) {
                if (1 & n && t._UZ(0, "moey-room-hotpoints", 9), 2 & n) {
                    const e = t.oxw(2);
            ...
            function Ke(n, l) {
                if (1 & n && t._UZ(0, "moey-room-compare", 10), 2 & n) {
            ...
            function Wt(n, l) {
                if (1 & n && (t.TgZ(0, "div", 11), t._UZ(1, "div", 12), t.ALo(2, "flTranslate"), t.qZA()), 2 & n) {
                    const e = t.oxw().ngrxLet,
                        o = t.oxw();
                    t.xp6(1), t.Q6J("type", o.moeyLoaderType.stars)("showProgress", e.loadingData.isUpload)("progressValue", e.loadingData.loadingValue)("label", e.loadingData.loadLabel ? t.lcZ(2, 4, e.loadingData.loadLabel) : "")
                }
            }
            ...
            function Le(n, l) {
                if (1 & n) {
                    ...
                    t.TgZ(0, "div", 13), t.NdJ("click", function() {
                        ...
                        const r = t.oxw(2);
                        return t.KtG(r.zoomTutorialInteraction())
                    }), t._UZ(1, "moey-zoom-tutorial"), t.qZA()
                }
                if (2 & n) {
                    const e = t.oxw().ngrxLet;
            ...
            function Se(n, l) {
                if (1 & n) {
                    ...
                    }), t.qZA(), t.TgZ(3, "div", 3, 4), t.YNc(5, ae, 1, 1, "moey-room-hotpoints", 5), t.qZA(), t.YNc(6, Ke, 1, 3, "moey-room-compare", 6), t.YNc(7, Wt, 3, 6, "div", 7), t.YNc(8, Le, 2, 2, "div", 8), t.BQk()
                }
                if (2 & n) {
                    const e = l.ngrxLet;
            ...
            let ce = (() => {
                class n extends q.YU {
                    constructor() {
                        super(...arguments), this.store = (0, t.f3M)(pt), this.cdr = (0, t.f3M)(t.sBO), this.loading$ = this.store.loading$, this.loadingData$ = this.store.loadingData$, this.canvasReady$ = this.store.canvasReady$, this.compareImage$ = this.store.compareImage$, this.showHotpoints$ = this.store.showHotpoints$, this.showCompare$ = this.store.showCompare$, this.isLayoutOn$ = this.store.isLayoutOn$, this.zoomTutorialSeen$ = this.store.zoomTutorialSeen$, this.isZoomed$ = this.store.isZoomed$, this.isVerticalZoom$ = this.store.isVerticalZoom$, this.viewerSettings$ = this.store.viewerSettings$, this.moeyLoaderType = Xt.R
                    }
                    ngAfterViewInit() {
                ...
                return n.\u0275fac = function() {
                    ...
                    consts: [
                        ...
                        [1, "loader-wrapper"],
                        ["moey-loader", "", 1, "moey-ai-loader", 3, "type", "showProgress", "progressValue", "label"],
                    ...
                    styles: [".moey-room-viewer{display:flex;position:relative;justify-content:center;align-items:center}.moey-room-viewer canvas.zoomed{cursor:move;cursor:grab}.moey-room-viewer canvas.zoomed:active{cursor:grabbing}.moey-room-viewer #zoom-btn{position:fixed;left:16px;bottom:45%;z-index:11}.moey-room-viewer .hotpoints-wrapper{position:absolute;pointer-events:none}.moey-room-viewer .download{position:absolute;top:25px;left:25px}.moey-room-viewer .loader-wrapper{display:flex;justify-content:center;align-items:center;position:absolute;background-color:#0009;border-radius:12px;width:220px;height:220px}.moey-room-viewer .zoom-tutorial{position:absolute;inset:0;display:flex;justify-content:center;align-items:center}.moey-room-viewer .zoom-tutorial .moey-zoom-tutorial{max-width:246px}.moey-room-viewer .moey-ai-loader{color:#fafafa}.moey-room-viewer canvas,.moey-room-viewer .hotpoints-wrapper{animation:1.5s ease 0s normal forwards 1 gentleShow;opacity:0}.moey-room-viewer canvas.loaded,.moey-room-viewer .hotpoints-wrapper.loaded{opacity:1}@keyframes gentleShow{0%{opacity:0}90%{opacity:0}to{opacity:1}}\n"],
                    encapsulation: 2,
                    changeDetection: 0
                }), n
            })();
            ...
            let De = (() => {
                ...
                return n.\u0275fac = function(e) {
                    ...
                    hostAttrs: [1, "moey-sizes-dialog"],
                    standalone: !0,
                    features: [t.jDz],
                    decls: 14,
                    vars: 12,
                    consts: [
                        [1, "moey-dialog-header"],
                        ["moey-dialog-content", ""],
                        [1, "sizes-grid"],
                        ["moey-button", "", "class", "outline reverse small size-button", 3, "selected", "click", 4, "ngFor", "ngForOf", "ngForTrackBy"],
                        ["moey-dialog-actions", ""],
                        ["moey-button", "", "moey-dialog-close", "", 1, "moey-button", "outline", "reverse", "big", "close-btn"],
                        [1, "moey-button", "primary", "big", 3, "moey-dialog-close"],
                        ["moey-button", "", 1, "outline", "reverse", "small", "size-button", 3, "click"],
                        [1, "size-label"],
                        ["class", "size-price", 4, "ngIf"],
                        [1, "size-price"]
                    ],
                    template: function(e, o) {
                        1 & e && (t.TgZ(0, "div", 0)(1, "span"), t._uU(2), t.ALo(3, "flTranslate"), t.qZA()(), t.TgZ(4, "section", 1)(5, "div", 2), t.YNc(6, Ae, 5, 6, "button", 3), t.qZA()(), t.TgZ(7, "div", 4)(8, "button", 5), t._uU(9), t.ALo(10, "flTranslate"), t.qZA(), t.TgZ(11, "button", 6), t._uU(12), t.ALo(13, "flTranslate"), t.qZA()()), 2 & e && (t.xp6(2), t.Oqu(t.lcZ(3, 6, "chooseRugSize")), t.xp6(4), t.Q6J("ngForOf", o.sizes)("ngForTrackBy", o.trackBySize), t.xp6(3), t.hij(" ", t.lcZ(10, 8, "close"), " "), t.xp6(2), t.Q6J("moey-dialog-close", o.selectedSize), t.xp6(1), t.hij(" ", t.lcZ(13, 10, "choose"), " "))
                    },
                    dependencies: [u.ez, u.sg, u.O5, at.N, rt.X, gt.wC, xt.VA, xt.BK, xt.hE, he.Iu, _t.c, Ee.u5, ee.vO],
                    styles: ["[_nghost-%COMP%]{display:flex;flex-direction:column;flex:1;margin:auto;max-height:60vh;width:80vw;background-color:var(--fl-bg);border-radius:var(--fl-border-radius)}[_nghost-%COMP%]   .moey-dialog-header[_ngcontent-%COMP%]{justify-content:center;padding:var(--fl-y-padding-md) 0;border-bottom:0}[_nghost-%COMP%]   .moey-dialog-header[_ngcontent-%COMP%]   span[_ngcontent-%COMP%]{font-weight:600;font-size:1rem;line-height:1.25rem;color:var(--fl-fg)}[_nghost-%COMP%]   .moey-dialog-content[_ngcontent-%COMP%]{margin:0 var(--fl-x-padding-md) var(--fl-x-padding-s);padding:0;overflow-y:scroll}[_nghost-%COMP%]   .moey-dialog-content[_ngcontent-%COMP%]   .sizes-grid[_ngcontent-%COMP%]{display:grid;grid-template-columns:1fr;gap:var(--fl-x-padding-s)}@media only screen and (min-width: 500px){[_nghost-%COMP%]   .moey-dialog-content[_ngcontent-%COMP%]   .sizes-grid[_ngcontent-%COMP%]{grid-template-columns:1fr 1fr}}[_nghost-%COMP%]   .moey-dialog-content[_ngcontent-%COMP%]   .sizes-grid[_ngcontent-%COMP%]   .size-button[_ngcontent-%COMP%]{height:3rem}[_nghost-%COMP%]   .moey-dialog-content[_ngcontent-%COMP%]   .sizes-grid[_ngcontent-%COMP%]   .size-button[_ngcontent-%COMP%]   span[_ngcontent-%COMP%]{flex:1}[_nghost-%COMP%]   .moey-dialog-content[_ngcontent-%COMP%]   .sizes-grid[_ngcontent-%COMP%]   .size-button[_ngcontent-%COMP%]   .size-label[_ngcontent-%COMP%]{font-weight:500;font-size:.75rem;line-height:1rem;color:var(--fl-fg)}[_nghost-%COMP%]   .moey-dialog-content[_ngcontent-%COMP%]   .sizes-grid[_ngcontent-%COMP%]   .size-button[_ngcontent-%COMP%]   .size-price[_ngcontent-%COMP%]{font-weight:700;font-size:.625rem;line-height:.75rem;color:var(--fl-fg700)}[_nghost-%COMP%]   .moey-dialog-content[_ngcontent-%COMP%]   .sizes-grid[_ngcontent-%COMP%]   .size-button.selected[_ngcontent-%COMP%]{border-color:var(--fl-primary)}[_nghost-%COMP%]   .moey-dialog-actions[_ngcontent-%COMP%]{margin:0 var(--fl-x-padding-md) var(--fl-y-padding-md);padding:0;display:flex;justify-content:center}[_nghost-%COMP%]   .moey-dialog-actions[_ngcontent-%COMP%]   .moey-button[_ngcontent-%COMP%]{flex:1}[_nghost-%COMP%]   .moey-dialog-actions[_ngcontent-%COMP%]   .moey-button.close-btn[_ngcontent-%COMP%]{margin-right:var(--fl-x-padding-s)}"],
                    changeDetection: 0
                }), n
            })();
            var pe = c(5325),
            ...
            let ct = (() => {
                ...
                return n.\u0275fac = function(e) {
                    ...
                    type: n,
                    selectors: [
                        ["moey-calculator-dialog"]
                    ],
                    hostAttrs: [1, "moey-calculator-dialog"],
                    standalone: !0,
                    features: [t.jDz],
                    decls: 6,
                    vars: 3,
                    ...
                    template: function(e, o) {
                        1 & e && (t.TgZ(0, "div", 0), t.ynx(1), t._uU(2), t.ALo(3, "flTranslate"), t.BQk(), t.qZA(), t.TgZ(4, "section", 1), t._UZ(5, "moey-calculator"), t.qZA()), 2 & e && (t.xp6(2), t.hij(" ", t.lcZ(3, 1, "calculator.title"), " "))
                    },
                    dependencies: [at.N, rt.X, ie.A, gt.wC, xt.hE, Ve.C],
                    styles: [".moey-calculator-dialog{display:flex;flex-direction:column;height:100%;background-color:var(--fl-bg);border-radius:var(--fl-border-radius);min-width:374px}@media (min-width: 768px){.moey-calculator-dialog{max-height:700px;max-width:540px;flex:0}}\n"],
                    encapsulation: 2,
                    changeDetection: 0
                }), n
            })();
            ...
            function Ne(n, l) {
                if (1 & n) {
                    ...
                    }), t._UZ(2, "div", 11)(3, "moey-icon", 12), t.qZA()
                }
                if (2 & n) {
                    const e = t.oxw().$implicit,
                        o = t.oxw().ngrxLet,
                        r = t.oxw();
                    t.ekj("selected", e.type === (null == o.barButtons.activeBtn ? null : o.barButtons.activeBtn.type))("moey-button-animation", r.animatedButtons.includes(e.type)), t.Q6J("moeySkeletonLoader", o.loading), t.uIk("aria-label", e.type), t.xp6(2), t.ekj("moey-dot", r.animatedButtons.includes(e.type)), t.Q6J("ngClass", e.afterAnimation ? "hidden" : ""), t.xp6(1), t.Q6J("name", e.icon)
                }
            }
                ...
                if (1 & n) {
                    ...
                    t.TgZ(0, "button", 14, 10), t.NdJ("click", function() {
                        ...
                        const r = t.oxw().$implicit,
                            g = t.oxw(2);
                        return t.KtG(g.hideTooltip(r.type))
                    }), t._UZ(2, "moey-icon", 12), t.qZA()
                }
                if (2 & n) {
                    const e = t.oxw().$implicit,
                        o = t.oxw().ngrxLet;
                    t.ekj("selected", e.type === (null == o.barButtons.activeBtn ? null : o.barButtons.activeBtn.type)), t.Q6J("id", e.id)("moeySkeletonLoader", o.loading), t.xp6(2), t.Q6J("name", e.icon)
                }
            }
            ...
            function Ie(n, l) {
                if (1 & n && t._UZ(0, "moey-icon", 12), 2 & n) {
            ...
            function ze(n, l) {
                if (1 & n) {
                    ...
                    }), t.YNc(1, Ie, 1, 1, "moey-icon", 18), t._uU(2), t.ALo(3, "flTranslate"), t.qZA()
                }
                if (2 & n) {
                    const e = t.oxw(2).ngrxLet,
                        o = t.oxw();
                    t.Q6J("ngClass", t.WLB(7, ve, (e.barButtons.ctaCount || 0) >= 1, 1 !== (e.barButtons.ctaCount || 0)))("moeyTrackClick", o.trackingEvents.buttonClick)("props", t.DdM(10, $e)), t.xp6(1), t.Q6J("ngIf", null == e.barButtons.quoteButton ? null : e.barButtons.quoteButton.icon), t.xp6(1), t.hij(" ", t.lcZ(3, 5, "quote.standardTitle"), " ")
                }
            }
            ...
            function Qe(n, l) {
                if (1 & n) {
                    ...
                    }), t._UZ(1, "moey-icon", 19), t._uU(2), t.qZA()
                }
                if (2 & n) {
                    const e = t.oxw(2).ngrxLet,
                        o = t.oxw();
                    t.Q6J("ngClass", t.kEZ(4, _e, 1 === (e.barButtons.ctaCount || 0), (e.barButtons.ctaCount || 0) > 1, 1 !== (e.barButtons.ctaCount || 0)))("moeyTrackClick", o.trackingEvents.buttonClick)("props", t.DdM(8, Je)), t.xp6(2), t.hij(" ", (null == e.barButtons.customButton ? null : e.barButtons.customButton.label) || "", " ")
                }
            }
            ...
            function i(n, l) {
                if (1 & n) {
                    ...
                    }), t.YNc(1, b, 1, 1, "moey-icon", 18), t._uU(2), t.ALo(3, "flTranslate"), t.qZA()
                }
                if (2 & n) {
                    const e = t.oxw(2).ngrxLet,
                        o = t.oxw();
                    t.Q6J("ngClass", t.kEZ(7, _e, 1 === (e.barButtons.ctaCount || 0), (e.barButtons.ctaCount || 0) > 1, 1 !== (e.barButtons.ctaCount || 0)))("moeyTrackClick", o.trackingEvents.buttonClick)("props", t.DdM(11, a)), t.xp6(1), t.Q6J("ngIf", null == e.barButtons.sampleButton ? null : e.barButtons.sampleButton.icon), t.xp6(1), t.hij(" ", t.lcZ(3, 5, "sample.standardTitle"), " ")
                }
            }
            ...
            function _(n, l) {
                if (1 & n) {
                    ...
                    }), t._UZ(5, "moey-icon", 5), t.qZA()(), t.TgZ(6, "div", 6), t.YNc(7, be, 4, 5, "ng-container", 3), t.qZA()(), t.YNc(8, s, 4, 5, "div", 7), t.BQk()
                }
                if (2 & n) {
                    const e = l.ngrxLet,
                        o = t.oxw();
                    t.xp6(3), t.Q6J("ngForOf", (null == e.barButtons ? null : e.barButtons.firstButtonSection) || t.DdM(6, h))("ngForTrackBy", o.buttonTrackBy), t.xp6(1), t.Q6J("moeySkeletonLoader", e.loading), t.xp6(3), t.Q6J("ngForOf", (null == e.barButtons ? null : e.barButtons.secondButtonSection) || t.DdM(7, h))("ngForTrackBy", o.buttonTrackBy), t.xp6(1), t.Q6J("ngIf", e.barButtons.ctaCount > 0 && !e.isMobileLandscape)
                }
            }
            ...
            let j = (() => {
                ...
                return n.\u0275fac = function() {
                    ...
                    hostAttrs: [1, "moey-visualisation-actions"],
                    inputs: {
                    ...
                    consts: [
                        ...
                        [1, "moey-icon-button", "secondary", "burger-btn", 3, "moeySkeletonLoader", "click"],
                        ["name", "fl_burger"],
                        [1, "second"],
                        ["class", "visualisation-actions-cta", 3, "single", 4, "ngIf"],
                        ["class", "moey-icon-button secondary", 3, "selected", "moey-button-animation", "moeySkeletonLoader", "click", "mouseenter", "mouseleave", 4, "ngIf"],
                        [1, "moey-icon-button", "secondary", 3, "moeySkeletonLoader", "click", "mouseenter", "mouseleave"],
                        ["actionButtonRef", ""],
                        [3, "ngClass"],
                        [3, "name"],
                        ["class", "moey-icon-button secondary", 3, "id", "selected", "moeySkeletonLoader", "click", "mouseenter", "mouseleave", 4, "ngIf"],
                        [1, "moey-icon-button", "secondary", 3, "id", "moeySkeletonLoader", "click", "mouseenter", "mouseleave"],
                        [1, "visualisation-actions-cta"],
                        ["moey-button", "", "class", "reverse", 3, "ngClass", "moeyTrackClick", "props", "click", 4, "ngIf"],
                        ["moey-button", "", 1, "reverse", 3, "ngClass", "moeyTrackClick", "props", "click"],
                        [3, "name", 4, "ngIf"],
                        ["name", "fl_add_o"]
                    ],
                    template: function(e, o) {
                    ...
                    styles: [".visualisation-actions-cta{display:grid;grid-template-columns:repeat(2,calc(50% - 8px));grid-gap:var(--fl-x-padding-xs);justify-content:space-between;padding:0 var(--fl-x-padding-xs)}.visualisation-actions-cta.single{display:flex;justify-content:center;background-color:var(--fl-primary);padding:0}.visualisation-actions-cta.single .moey-button{flex:1}.visualisation-actions-cta:not(.single){margin-bottom:var(--fl-y-padding-xs);align-items:center}.visualisation-actions-cta:not(.single) .moey-button{max-width:45vw}.visualisation-actions-cta moey-icon{width:1.25rem;height:1.25rem;margin:1px .5rem}@media (min-width: 769px){.visualisation-actions-cta{display:none!important}}.visualisation-action-buttons{display:flex;justify-content:space-between;padding:.5rem var(--fl-x-padding);border-top:solid 1px var(--fl-bg100);max-width:100vw}@media (orientation: landscape) and (min-width: 768px){.visualisation-action-buttons{flex-direction:column;height:100%;padding:var(--fl-x-padding) .5rem}}@media (orientation: landscape) and (min-width: 1024px){.visualisation-action-buttons{flex-direction:column;height:100%;padding:var(--fl-x-padding) .5rem}}.visualisation-action-buttons .first,.visualisation-action-buttons .cta-wrapper,.visualisation-action-buttons .second{display:flex}@media (orientation: landscape) and (min-width: 768px){.visualisation-action-buttons .first,.visualisation-action-buttons .cta-wrapper,.visualisation-action-buttons .second{flex-direction:column}}.visualisation-action-buttons .first .moey-icon-button,.visualisation-action-buttons .second .moey-icon-button{position:relative}.visualisation-action-buttons .first{flex:2}@media (max-width: 767px){.visualisation-action-buttons .first{justify-content:space-between}}@media (min-width: 768px){.visualisation-action-buttons .first .burger-btn{display:none}}.visualisation-action-buttons .first .moey-icon-button{align-self:center}@media (orientation: landscape) and (min-width: 768px){.visualisation-action-buttons .first .moey-icon-button{margin:0 0 .5rem}}@media (orientation: landscape) and (min-width: 1024px){.visualisation-action-buttons .first .moey-icon-button{margin:0 0 .5rem}}@media (orientation: portrait) and (min-width: 768px){.visualisation-action-buttons .first .moey-icon-button{margin:0 .5rem 0 0}}.visualisation-action-buttons .first .moey-button-animation{position:relative;animation:background-animation 1s}.visualisation-action-buttons .first .moey-button-animation .moey-dot{position:absolute;top:50%;left:50%;z-index:5;transform:translate(-50%,-50%);background-color:var(--fl-primary);opacity:0;width:.375rem;height:.375rem;border-radius:50%;animation:dot-animation 2s forwards}.visualisation-action-buttons .first .moey-button-animation .moey-dot.hidden{display:none}.visualisation-action-buttons .first .moey-button-animation moey-icon{animation:appearance-animation 1s}.visualisation-action-buttons .second{display:none}@media (min-width: 768px){.visualisation-action-buttons .second{display:flex}}@media (orientation: portrait){.visualisation-action-buttons .second .moey-icon-button{margin:0 0 0 .5rem}}@media (orientation: landscape) and (min-width: 768px){.visualisation-action-buttons .second .moey-icon-button{margin:.5rem 0 0}}@media (orientation: landscape) and (min-width: 1024px){.visualisation-action-buttons .second .moey-icon-button{margin:.5rem 0 0}}@keyframes background-animation{0%{transform:scale(0)}50%{background-color:var(--fl-primary100)}85%{background-color:var(--fl-primary100)}to{transform:scale(1);background-color:transparent}}@keyframes dot-animation{0%{opacity:0}50%{opacity:.2;transform:scale(.5)}to{opacity:1;transform:translate(10px) translateY(-14px) scale(1)}}@keyframes appearance-animation{0%{opacity:0;transform:scale(3)}50%{opacity:.5;transform:scale(1.5);color:var(--fl-primary800)}75%{opacity:.8;transform:scale(1);color:var(--fl-primary)}to{opacity:1;color:var(--fl-fg800)}}\n"],
                    encapsulation: 2,
                    changeDetection: 0
                }), n
            })();
            ...
            function nt(n, l) {
                if (1 & n && t._UZ(0, "moey-icon", 11), 2 & n) {
                    const e = t.oxw();
                    t.Q6J("name", e.icon)
                }
            }
            ...
            let di = (() => {
                ...
                return n.\u0275fac = function(e) {
                    ...
                    type: n,
                    selectors: [
                        ["moey-action-container-header"]
                    ],
                    hostAttrs: [1, "moey-action-container-header"],
                    inputs: {
                    ...
                    consts: [
                        ...
                        [1, "moey-action-container-header-title"],
                        ["class", "primary", 3, "name", 4, "ngIf"],
                        [1, "bold"],
                        [1, "moey-action-container-header-actions"],
                        ["moey-button", "", "class", "small outline sizes-dialog-handler", 3, "click", 4, "ngIf"],
                        ["class", "info-container prevent-select", 3, "mouseenter", "mouseleave", "mousedown", "mouseup", 4, "ngIf"],
                        ["moey-icon-button", "", "class", "small outline remove-product-handler", 3, "click", 4, "ngIf"],
                        ["moey-icon-button", "", 1, "small", "outline", "no-border", "close-handler", 3, "click"],
                        ["name", "fl_close"],
                        ["class", "feature-message-mobile", 4, "ngIf"],
                        [1, "primary", 3, "name"],
                        ["moey-button", "", 1, "small", "outline", "sizes-dialog-handler", 3, "click"],
                        [1, "info-container", "prevent-select", 3, "mouseenter", "mouseleave", "mousedown", "mouseup"],
                        ["infoContainerRef", ""],
                        ["name", "fl_info_o", 1, "primary"],
                        ["moey-icon-button", "", 1, "small", "outline", "remove-product-handler", 3, "click"],
                        ["name", "fl_trash_o"],
                        [1, "feature-message-mobile"]
                    ],
                    template: function(e, o) {
                        1 & e && (t.F$t(), t.TgZ(0, "div", 0)(1, "div", 1), t.YNc(2, nt, 1, 1, "moey-icon", 2), t.TgZ(3, "p", 3), t._uU(4), t.qZA()(), t.TgZ(5, "div", 4), t.YNc(6, it, 3, 3, "button", 5), t.Hsn(7), t.YNc(8, ut, 3, 0, "div", 6), t.YNc(9, wt, 2, 0, "button", 7), t.TgZ(10, "button", 8), t.NdJ("click", function() {
                            return o.closeHandler()
                        }), t._UZ(11, "moey-icon", 9), t.qZA()()(), t.YNc(12, Mt, 2, 1, "div", 10)), 2 & e && (t.xp6(2), t.Q6J("ngIf", o.icon), t.xp6(2), t.Oqu(o.title), t.xp6(2), t.Q6J("ngIf", (null == o.activeProduct ? null : o.activeProduct.type) === o.rugType && !!o.selectedSize), t.xp6(2), t.Q6J("ngIf", "addToCart" === o.headerType), t.xp6(1), t.Q6J("ngIf", o.activeProduct), t.xp6(3), t.Q6J("ngIf", o.message))
                    },
                    dependencies: [u.ez, u.O5, ht.K, _t.c, gt.wC, at.N, ee.vO],
                    styles: [".moey-action-container-header{display:flex;flex-direction:column;justify-content:space-between;align-items:center;padding:.75rem .5rem;background-color:var(--fl-bg);width:100%}.moey-action-container-header .action-container-header-wrapper{width:100%;display:flex;justify-content:space-between}.moey-action-container-header .feature-message-mobile{background-color:var(--fl-primary100);border-radius:.25rem;width:100%;padding:var(--fl-y-padding-xs);margin:var(--fl-y-padding-xs) var(--fl-y-padding-xs) 0}.moey-action-container-header .feature-message-mobile span{color:var(--fl-primary)}@media (orientation: landscape){.moey-action-container-header .feature-message-mobile{display:none}}.moey-action-container-header.border-radius{border-top-left-radius:var(--fl-border-radius);border-top-right-radius:var(--fl-border-radius)}.moey-action-container-header .moey-action-container-header-actions{display:flex;align-items:center}.moey-action-container-header .moey-action-container-header-actions .info-container{width:32px;height:32px;position:relative;display:flex;justify-content:center;align-items:center}.moey-action-container-header .moey-action-container-header-actions .prevent-select{-webkit-touch-callout:none;-webkit-user-select:none;user-select:none}.moey-action-container-header .moey-action-container-header-actions .sizes-dialog-handler{margin-right:var(--fl-x-padding-xs)}@media (min-width: 768px){.moey-action-container-header .moey-action-container-header-actions .sizes-dialog-handler{display:none}}.moey-action-container-header .moey-action-container-header-actions .remove-product-handler,.moey-action-container-header .moey-action-container-header-actions .close-handler{margin-left:var(--fl-x-padding-xs)}.moey-action-container-header .moey-action-container-header-title{display:flex;align-items:center}.moey-action-container-header .moey-action-container-header-title p{color:var(--fl-fg)}.moey-action-container-header .moey-action-container-header-title moey-icon{color:var(--fl-primary);margin-right:.75rem}\n"],
                    encapsulation: 2,
                    changeDetection: 0
                }), n
            })();
            ...
            function mi(n, l) {
                if (1 & n) {
                    const e = t.EpF();
                    t.ynx(0), t.TgZ(1, "moey-action-container-header", 2), t.NdJ("closeClick", function() {
                        t.CHM(e);
                        const r = t.oxw(2);
            ...
            let We = (() => {
                ...
                return n.\u0275fac = function() {
                    ...
                    type: n,
                    selectors: [
                        ["moey-action-container"]
                    ],
                    hostAttrs: [1, "moey-action-container"],
                    inputs: {
                        inDialog: "inDialog",
                    ...
                    consts: [
                        [4, "ngIf"],
                        [4, "ngrxLet"],
                        ["moeyDragContainerHandle", "", 3, "activeProduct", "selectedSize", "title", "icon", "message", "headerType", "closeClick", "clearClick", "sizesDialogClick"],
                    ...
                    styles: [".moey-action-container{display:flex;flex-direction:column;height:100%;background-color:var(--fl-bg);border-radius:var(--fl-border-radius)}@media (max-width: 1023px) and (orientation: portrait){.moey-action-container{max-width:100vw}}@media (max-width: 767px) and (orientation: landscape){.moey-action-container{width:204px;max-height:100dvh}}.moey-action-container .action-container-view{height:inherit;position:relative;overflow:auto;background-color:var(--fl-bg100)}@media (orientation: portrait){.moey-action-container .action-container-view{height:140px}}@media (min-width: 768px) and (orientation: landscape){.moey-action-container .action-container-view{border-bottom-right-radius:var(--fl-border-radius);border-bottom-left-radius:var(--fl-border-radius)}}.moey-action-container .action-container-view .action-container-view-inner{height:inherit}\n"],
                    encapsulation: 2,
                    changeDetection: 0
                }), n
            })();
            ...
            function _i(n, l) {
                if (1 & n) {
                    const e = t.EpF();
                    t.TgZ(0, "moey-action-container", 2), t.NdJ("closeContainer", function() {
                        t.CHM(e);
                        const r = t.oxw(2);
            ...
            function wi(n, l) {
                if (1 & n && (t.ynx(0), t.YNc(1, _i, 1, 2, "moey-action-container", 1), t.BQk()), 2 & n) {
                    const e = l.ngrxLet;
            ...
            function Ci(n, l) {
                ...
                if (2 & n) {
                    const e = t.oxw();
                    t.xp6(1), t.ekj("moey-pointer", !!e.vendorUrl), t.Q6J("src", e.logoUrl, t.LSH)
                }
            }

            function Ti(n, l) {
                if (1 & n && (t.TgZ(0, "p", 4)(1, "a", 5), t._uU(2, "Powered by moey"), t.qZA()()), 2 & n) {
                    const e = t.oxw();
                    t.xp6(1), t.Q6J("href", e.moeyUrl, t.LSH)
                }
            }
            let Oi = (() => {
                class n {
                    constructor() {
                        this.logoUrl = "", this.showLogo = !1, this.showmoeyText = !1, this.vendorUrl = "", this.vendorUrlClick = new t.vpe, this.cls = ["moey-powered-by"], this.moeyUrl = pe.N.moeyWebsite
                    }
                    openVendorUrl() {
                ...
                return n.\u0275fac = function(e) {
                    ...
                    consts: [
                        ...
                        ["class", "moey-caption moey-light", 4, "ngIf"],
                        [1, "company-logo"],
                        ["loading", "lazy", "alt", "company logo", 3, "src", "click"],
                        [1, "moey-caption", "moey-light"],
                        ["target", "_blank", 1, "moey-url", 3, "href"]
                    ],
                    template: function(e, o) {
                        1 & e && (t.YNc(0, Ci, 2, 3, "div", 0), t.YNc(1, Ti, 3, 1, "p", 1)), 2 & e && (t.Q6J("ngIf", o.showLogo && o.logoUrl), t.xp6(1), t.Q6J("ngIf", o.showmoeyText))
                    },
                    dependencies: [u.ez, u.O5],
                    styles: [".moey-powered-by{display:flex;justify-content:space-between;align-items:center;padding:0 var(--fl-x-padding) 0 0}.moey-powered-by .company-logo{max-height:40px;height:40px;margin-right:var(--fl-x-padding-xs)}.moey-powered-by .company-logo img{height:2.5rem}.moey-powered-by .moey-url{text-decoration:none;outline:none;color:var(--fl-fg)}\n"],
                    encapsulation: 2,
                    changeDetection: 0
                }), n
            })();
            ...
            let ni = (() => {
                ...
                return n.\u0275fac = function(e) {
                    ...
                    consts: [
                        ...
                        ["moey-dialog-content", ""],
                        ["moey-dialog-actions", ""],
                        [1, "moey-button", "outline", "moey-w100prc", 3, "click"],
                        [1, "moey-button", "primary", "moey-w100prc", 3, "click"],
                    ...
                    styles: ["[_nghost-%COMP%]{background-color:var(--fl-bg);border-radius:var(--fl-border-radius);max-width:300px}[_nghost-%COMP%]   .moey-dialog-content[_ngcontent-%COMP%]{min-width:252px}[_nghost-%COMP%]   .moey-dialog-content[_ngcontent-%COMP%]   p[_ngcontent-%COMP%]{text-align:center}[_nghost-%COMP%]   .moey-dialog-content[_ngcontent-%COMP%]   div[_ngcontent-%COMP%]{display:flex;justify-content:center}[_nghost-%COMP%]   .moey-button.outline[_ngcontent-%COMP%]{margin-bottom:var(--fl-y-padding)}@media (max-width: 1023px){[_nghost-%COMP%]   .moey-button.outline[_ngcontent-%COMP%]{display:none}}"],
                    changeDetection: 0
                }), n
            })();
            var Rt = (() => {
            ...
            function Ji(n, l) {
                if (1 & n) {
                    ...
                    }), t._UZ(1, "moey-icon", 35), t._uU(2), t.ALo(3, "flTranslate"), t.qZA()
                }
                if (2 & n) {
                    const e = t.oxw().ngrxLet,
                        o = t.oxw();
                    t.ekj("fav", e.data.isLiked), t.Q6J("moeyTrackClick", o.trackingEvents.addToFav)("props", t.l5B(7, zi, null == e.data.activeProduct || null == e.data.activeProduct.name ? null : e.data.activeProduct.name.default, null == e.data.activeProduct ? null : e.data.activeProduct.sku, null == e.activeRoom ? null : e.activeRoom.name, e.data.isLiked)), t.xp6(2), t.hij(" ", t.lcZ(3, 5, "floatingBar.addToFav"), " ")
                }
            }
            ...
            function Qi(n, l) {
                if (1 & n) {
                    ...
                    }), t._UZ(1, "moey-icon", 37), t._uU(2), t.ALo(3, "flTranslate"), t.qZA()
                }
            ...
            function ji(n, l) {
                if (1 & n) {
                    ...
                    }), t._UZ(1, "moey-icon", 39), t._uU(2), t.ALo(3, "flTranslate"), t.qZA()
                }
            ...
            function qi(n, l) {
                if (1 & n) {
                    ...
                    }), t._uU(2), t.ALo(3, "sizeMapping"), t._UZ(4, "moey-icon", 42), t.qZA()
                }
                if (2 & n) {
                    const e = t.oxw().ngrxLet,
                        o = t.oxw();
            ...
            function Xi(n, l) {
                if (1 & n) {
                    const e = t.EpF();
                    t.TgZ(0, "moey-radio", 46), t.NdJ("click", function() {
                        const g = t.CHM(e).$implicit,
                            O = t.oxw(3);
            ...
            function to(n, l) {
                if (1 & n && (t.TgZ(0, "div", 43, 44), t.YNc(2, Xi, 3, 6, "moey-radio", 45), t.qZA()), 2 & n) {
                    const e = t.oxw().ngrxLet,
                        o = t.oxw();
            ...
            let uo = (() => {
                ...
                return n.\u0275fac = function(e) {
                    ...
                    hostAttrs: [1, "moey-base-bar-details"],
                    hostBindings: function(e, o) {
                    ...
                    consts: [
                        [4, "ngrxLet"],
                        ["moey-icon-button", "", 1, "small", "close-btn", 3, "click"],
                        ["name", "fl_close"],
                        [1, "selected-product-labels"],
                        [1, "moey-caption", "moey-semi-regular"],
                        [1, "fl-mt-8", "moey-bold"],
                        ["class", "selected-product-additional-info", 4, "ngIf"],
                        [1, "split-view"],
                        [1, "product-img-preview"],
                        ["moey-picture", "", "class", "contain aspect-ratio-1-1", 3, "imgSet", 4, "ngIf"],
                        ["class", "product-rgba-color", 3, "ngStyle", 4, "ngIf"],
                        ["class", "rug-price-tag", 4, "ngIf"],
                        [1, "product-full-actions"],
                        ["moey-button", "", "class", "outline reverse fav-btn small", 3, "moeyTrackClick", "props", "fav", "click", 4, "ngIf"],
                        ["moey-button", "", "class", "outline reverse remove small", 3, "click", 4, "ngIf"],
                        ["moey-button", "", "class", "outline reverse small", 3, "click", 4, "ngIf"],
                        ["moey-button", "", "class", "outline reverse small select-btn", 3, "click", 4, "ngIf"],
                        ["moey-radio-group", "", "class", "select", 3, "ngClass", 4, "ngIf"],
                        ["moey-button", "", "class", "primary reverse small", 3, "moeyTrackClick", "props", "click", 4, "ngIf"],
                        ...
                        ["moey-picture", "", 1, "contain", "aspect-ratio-1-1", 3, "imgSet"],
                        [1, "product-rgba-color", 3, "ngStyle"],
                        [1, "rug-price-tag"],
                        ["moey-button", "", 1, "outline", "reverse", "fav-btn", "small", 3, "moeyTrackClick", "props", "click"],
                        ["name", "fl_heart_o"],
                        ["moey-button", "", 1, "outline", "reverse", "remove", "small", 3, "click"],
                        ["name", "fl_trash_o"],
                        ["moey-button", "", 1, "outline", "reverse", "small", 3, "click"],
                        ["name", "fl_pattern_o"],
                        ["moey-button", "", 1, "outline", "reverse", "small", "select-btn", 3, "click"],
                        ["sizesButton", ""],
                        ["name", "fl_chevron_left_s", 3, "ngClass"],
                        ["moey-radio-group", "", 1, "select", 3, "ngClass"],
                        ["sizesDiv", ""],
                        [3, "value", "checked", "click", 4, "ngFor", "ngForOf", "ngForTrackBy"],
                        [3, "value", "checked", "click"],
                        [4, "ngIf"],
                        ["moey-button", "", 1, "primary", "reverse", "small", 3, "moeyTrackClick", "props", "click"],
                        ...
                        [1, "product-ar-info"],
                        [1, "moey-bold", "fl-mb-8"],
                        [1, "moey-semi-regular", "moey-caption"],
                        ["moey-button", "", "class", "primary reverse small fl-mt-8", 3, "click", 4, "ngIf"],
                        ["moey-button", "", 1, "primary", "reverse", "small", "fl-mt-8", 3, "click"]
                    ],
                    template: function(e, o) {
                    ...
                    styles: [".moey-base-bar-details .selected-product-labels p.moey-bold{word-break:break-all}.moey-base-bar-details .selected-product-additional-info{display:grid;grid-template-columns:1fr 1fr;grid-gap:1rem;padding:var(--fl-y-padding) 0;border-bottom:1px solid var(--fl-border-clr)}.moey-base-bar-details .selected-product-additional-info .additional-info-element{display:flex;flex-direction:column;justify-content:flex-start}.moey-base-bar-details .selected-product-additional-info .additional-info-element.description{grid-column:1/3;text-align:justify;text-justify:inter-word}.moey-base-bar-details .selected-product-additional-info .additional-info-element.description:not(.expanded) .additional-info-value{overflow:hidden;text-overflow:ellipsis;display:-webkit-box;-webkit-box-orient:vertical;-ms-box-orient:vertical;-webkit-line-clamp:3;line-clamp:3}.moey-base-bar-details .selected-product-additional-info .additional-info-element .additional-info-header{text-transform:uppercase;margin-bottom:4px;font-weight:600;font-size:.625rem;line-height:.75rem;color:var(--fl-fg)}.moey-base-bar-details .selected-product-additional-info .additional-info-element .additional-info-value{font-weight:500;font-size:.75rem;line-height:1rem;color:var(--fl-fg700)}.moey-base-bar-details .selected-product-additional-info .additional-info-element .show-more-btn{width:auto;align-self:start;border:0;text-decoration:underline;padding:.25rem 0;font-weight:500;font-size:.75rem;line-height:1rem;color:var(--fl-primary)}.moey-base-bar-details .split-view .product-img-preview{position:relative}.moey-base-bar-details .split-view .product-img-preview .product-rgba-color{border-radius:var(--fl-border-radius);aspect-ratio:1/1}.moey-base-bar-details .split-view .product-img-preview .rug-price-tag{position:absolute;bottom:4px;right:8px;background-color:var(--fl-overlay);color:var(--fl-bg);padding:.25rem .5rem;border-radius:var(--fl-border-radius)}.moey-base-bar-details .product-full-actions{display:flex;flex-direction:column;position:relative}.moey-base-bar-details .product-full-actions .moey-button{width:100%;margin-bottom:var(--fl-y-padding-xs)}.moey-base-bar-details .product-full-actions .moey-button:last-of-type{margin-bottom:0}.moey-base-bar-details .product-full-actions .select-btn{flex-direction:row}.moey-base-bar-details .product-full-actions .select-btn p{flex:1}.moey-base-bar-details .product-full-actions .select-btn moey-icon{margin:0;transform:rotate(-90deg);transition:transform .3s ease-in-out}.moey-base-bar-details .product-full-actions .select-btn moey-icon.rotated{transform:rotate(90deg)}.moey-base-bar-details .product-full-actions .select{position:absolute;top:calc(50% + 40px);min-width:184px;background-color:var(--fl-bg100);border:1px solid var(--fl-border-clr);border-radius:var(--fl-border-radius);overflow:hidden;opacity:0;transform:scaleY(0);transform-origin:top;transition:opacity .3s ease-in-out,transform .3s ease-in-out;box-shadow:0 6px 10px #0000004d}.moey-base-bar-details .product-full-actions .select.opened{opacity:1;transform:scaleY(1)}.moey-base-bar-details .product-full-actions .select .moey-radio{margin-bottom:0;white-space:nowrap;border-radius:0;border-bottom:1px solid var(--fl-border-clr)}.moey-base-bar-details .product-full-actions .select .moey-radio .moey-radio-mark{display:none}.moey-base-bar-details .product-full-actions .select .moey-radio.checked .moey-radio-label{font-weight:700;color:var(--fl-primary)}.moey-base-bar-details .product-full-actions .select .moey-radio:hover{background-color:var(--fl-bg200)}.moey-base-bar-details .product-full-actions .select .moey-radio:last-of-type{border-bottom:0}\n"],
                    encapsulation: 2,
                    changeDetection: 0
                }), n
            })();
            ...
            function po(n, l) {
                if (1 & n) {
                    ...
                    }), t._UZ(1, "moey-icon", 14), t._uU(2), t.ALo(3, "flTranslate"), t.qZA()
                }
                2 & n && (t.xp6(2), t.hij(" ", t.lcZ(3, 1, "deleteBtn"), " "))
            }
            ...
            function fo(n, l) {
                if (1 & n) {
                    ...
                    t.ynx(0), t.TgZ(1, "button", 1), t.NdJ("click", function() {
                        ...
                        const r = t.oxw();
                        return t.KtG(r.changeShowDetails(!1))
                    }), t._UZ(2, "moey-icon", 2), t.qZA(), t.TgZ(3, "div", 3)(4, "p", 4), t._uU(5), t.ALo(6, "flTranslate"), t.qZA(), t.TgZ(7, "p", 5), t._uU(8), t.qZA()(), t.TgZ(9, "div", 6)(10, "div", 7)(11, "div", 8), t._UZ(12, "picture", 9), t.qZA(), t.YNc(13, ho, 2, 1, "div", 10), t.qZA(), t.TgZ(14, "div", 11), t.YNc(15, po, 4, 3, "button", 12), t.qZA()(), t.BQk()
                }
                if (2 & n) {
                    const e = l.ngrxLet;
            ...
            let mo = (() => {
                ...
                return n.\u0275fac = function(e) {
                    ...
                    hostAttrs: [1, "moey-epoxy-bar-details"],
                    standalone: !0,
                    features: [t.jDz],
                    decls: 1,
                    vars: 4,
                    consts: [
                        ...
                        [1, "product-full-actions"],
                        ["moey-button", "", "class", "primary reverse remove small", 3, "click", 4, "ngIf"],
                        ["moey-button", "", 1, "primary", "reverse", "remove", "small", 3, "click"],
                        ["name", "fl_trash_o"]
                    ],
                    template: function(e, o) {
                    ...
                    styles: [".moey-epoxy-bar-details .selected-product-labels p.moey-bold{word-break:break-all}.moey-epoxy-bar-details .split-view{grid-template-columns:repeat(2,1fr)!important}.moey-epoxy-bar-details .product-full-actions{display:flex;flex-direction:column;justify-content:space-between}.moey-epoxy-bar-details .split-epoxy-images{display:flex}.moey-epoxy-bar-details .split-epoxy-images div,.moey-epoxy-bar-details .split-epoxy-images .product-img-preview{width:76px}.moey-epoxy-bar-details .split-epoxy-images .product-img-preview{margin-right:var(--fl-x-padding)}.moey-epoxy-bar-details .split-epoxy-images .product-img-preview:last-of-type{margin-right:0}.moey-epoxy-bar-details .split-epoxy-images div{height:76px;border:1px solid var(--fl-border-clr);border-radius:var(--fl-border-radius);background:url(/assets/images/no-image.svg) no-repeat;background-size:contain}\n"],
                    encapsulation: 2,
                    changeDetection: 0
                }), n
            })();
            ...
            function yo(n, l) {
                if (1 & n) {
                    ...
                    t.TgZ(0, "button", 16), t.NdJ("click", function() {
                        ...
                        const r = t.oxw(2);
                        return t.KtG(r.buyNow())
                    }), t.YNc(1, vo, 1, 0, "moey-icon", 17), t.YNc(2, _o, 2, 1, "ng-container", 18), t.YNc(3, wo, 3, 3, "ng-container", 18), t.qZA()
                }
                if (2 & n) {
                    const e = t.oxw().ngrxLet,
                        o = t.oxw();
            ...
            function Co(n, l) {
                if (1 & n) {
                    const e = t.EpF();
                    t.TgZ(0, "div", 20), t._UZ(1, "moey-icon", 21), t.TgZ(2, "p", 22), t._uU(3), t.ALo(4, "flTranslate"), t.qZA(), t.TgZ(5, "button", 23), t.NdJ("click", function() {
                        t.CHM(e);
                        const r = t.oxw(2);
                        return t.KtG(r.setToastStatus(!1))
                    }), t._UZ(6, "moey-icon", 24), t.qZA()()
                }
            ...
            function Oo(n, l) {
                if (1 & n) {
                    const e = t.EpF();
                    t.TgZ(0, "moey-powered-by", 25), t.NdJ("vendorUrlClick", function() {
                        t.CHM(e);
                        const r = t.oxw(2);
                        return t.KtG(r.openVendorUrl())
                    }), t.qZA()
                ...
                if (2 & n) {
                    const e = t.oxw().ngrxLet;
                    t.Q6J("showLogo", e.showHeader)("showmoeyText", !!e.showmoeyText)("logoUrl", e.logo)("vendorUrl", e.data.vendorUrl)
                }
            }

            function Po(n, l) {
                if (1 & n && t._UZ(0, "moey-icon", 28), 2 & n) {
                    const e = t.oxw(2).ngrxLet;
                    t.Q6J("name", null == e.barButtons.quoteButton ? null : e.barButtons.quoteButton.icon)
                }
            }
            ...
            function Bo(n, l) {
                if (1 & n) {
                    ...
                    }), t.YNc(1, Po, 1, 1, "moey-icon", 27), t._uU(2), t.ALo(3, "flTranslate"), t.qZA()
                }
                if (2 & n) {
                    const e = t.oxw().ngrxLet,
                        o = t.oxw();
                    t.Q6J("ngClass", t.VKq(7, Lo, (e.barButtons.ctaCount || 0) >= 1))("moeyTrackClick", o.trackingEvents.buttonClick)("props", t.DdM(9, So)), t.xp6(1), t.Q6J("ngIf", null == e.barButtons.quoteButton ? null : e.barButtons.quoteButton.icon), t.xp6(1), t.hij(" ", t.lcZ(3, 5, "quote.standardTitle"), " ")
                }
            }
                ...
                if (1 & n) {
                    ...
                    t.TgZ(0, "button", 26), t.NdJ("click", function() {
                        ...
                        const r = t.oxw().ngrxLet,
                            g = t.oxw();
                        return t.KtG(g.customBtnClick(r.barButtons.customButton))
                    }), t.YNc(1, Mo, 1, 1, "moey-icon", 27), t.YNc(2, Eo, 1, 0, "moey-icon", 29), t.YNc(3, ko, 3, 3, "ng-container", 18), t.YNc(4, Ao, 2, 1, "ng-container", 18), t.qZA()
                }
                if (2 & n) {
                    const e = t.oxw().ngrxLet,
                        o = t.oxw();
                    t.Q6J("ngClass", t.WLB(7, si, 1 === (e.barButtons.ctaCount || 0), (e.barButtons.ctaCount || 0) > 1))("moeyTrackClick", o.trackingEvents.buttonClick)("props", t.DdM(10, Do)), t.xp6(1), t.Q6J("ngIf", e.useBonaTranslations), t.xp6(1), t.Q6J("ngIf", !e.useBonaTranslations), t.xp6(1), t.Q6J("ngIf", e.useBonaTranslations), t.xp6(1), t.Q6J("ngIf", !e.useBonaTranslations)
                }
            }
            ...
            function Fo(n, l) {
                if (1 & n) {
                    ...
                    }), t.YNc(1, Ro, 1, 1, "moey-icon", 27), t._uU(2), t.ALo(3, "flTranslate"), t.qZA()
                }
                if (2 & n) {
                    const e = t.oxw().ngrxLet,
                        o = t.oxw();
                    t.Q6J("ngClass", t.WLB(7, si, 1 === (e.barButtons.ctaCount || 0), (e.barButtons.ctaCount || 0) > 1))("moeyTrackClick", o.trackingEvents.buttonClick)("props", t.DdM(10, Zo)), t.xp6(1), t.Q6J("ngIf", null == e.barButtons.sampleButton ? null : e.barButtons.sampleButton.icon), t.xp6(1), t.hij(" ", t.lcZ(3, 5, "sample.standardTitle"), " ")
                }
            }
            ...
            function No(n, l) {
                1 & n && t._UZ(0, "moey-base-details")
            }

            function Io(n, l) {
                1 & n && t._UZ(0, "moey-epoxy-details")
            }

            function $o(n, l) {
                if (1 & n && (t.TgZ(0, "div", 42), t.YNc(1, No, 1, 0, "moey-base-details", 18), t.YNc(2, Io, 1, 0, "moey-epoxy-details", 18), t.qZA()), 2 & n) {
                    const e = t.oxw(2).ngrxLet;
            ...
            function zo(n, l) {
                if (1 & n) {
                    ...
                    }), t._UZ(4, "moey-icon", 35), t.qZA(), t.TgZ(5, "div", 36), t.YNc(6, Vo, 1, 1, "picture", 37), t.qZA(), t.YNc(7, Uo, 2, 1, "div", 38), t.qZA(), t.YNc(8, $o, 3, 2, "div", 39), t.qZA()()
                }
                if (2 & n) {
                    const e = t.oxw().ngrxLet;
            ...
            let jo = (() => {
                class n {
                    constructor() {
                        this.store = (0, t.f3M)(we), this.logo$ = this.store.logo$, this.vm$ = this.store.vm$, this.showLayout$ = this.store.showLayout$, this.isMobileLandscape$ = this.store.isMobileLandscape$, this.showHeader$ = this.store.showHeader$, this.isDynamicMode$ = this.store.isDynamicMode$, this.hideFloatingDetails$ = this.store.hideFloatingDetails$, this.showmoeyText$ = this.store.showmoeyText$, this.barButtons$ = this.store.barButtons$, this.useBonaTranslations$ = this.store.useBonaTranslations$, this.bonaCtaButton$ = this.store.bonaCtaButton$, this.trackingEvents = p.y8
                    }
                    goHome() {
                        this.store.goToHome()
                    }
                ...
                return n.\u0275fac = function(e) {
                    ...
                    consts: [
                        [4, "ngrxLet"],
                        [1, "mobile", "moey-w100prc"],
                        [1, "floating-bar-wrapper"],
                        ["class", "floating-bar-actions", 4, "ngIf"],
                        [1, "floating-buy-quote"],
                        ["moey-button", "", "class", "primary reverse", 3, "moeyTrackClick", "props", "click", 4, "ngIf"],
                        ["class", "info-toast", 4, "ngIf"],
                        [1, "tablet", "floating-bar-product-wrapper", "moey-w100prc"],
                        [1, "floating-bar-company"],
                        ["moey-icon-button", "", "class", "outline home", 3, "click", 4, "ngIf"],
                        ["class", "moey-flex-1", 3, "showLogo", "showmoeyText", "logoUrl", "vendorUrl", "vendorUrlClick", 4, "ngIf"],
                        ["moey-button", "", "class", "reverse", 3, "ngClass", "moeyTrackClick", "props", "click", 4, "ngIf"],
                        ["class", "floating-bar-product-full-wrapper", 3, "hidden-ui", "show", 4, "ngIf"],
                        [1, "floating-bar-actions"],
                        ["moey-icon-button", "", 1, "outline", "home", 3, "click"],
                        ["name", "fl_leave"],
                        ["moey-button", "", 1, "primary", "reverse", 3, "moeyTrackClick", "props", "click"],
                        ["name", "fl_cart_o", 4, "ngIf"],
                        [4, "ngIf"],
                        ["name", "fl_cart_o"],
                        [1, "info-toast"],
                        ["name", "fl_info_s"],
                        [1, "moey-caption", "moey-semi-regular"],
                        ["moey-icon-button", "", 1, "small", 3, "click"],
                        ["name", "fl_close"],
                        [1, "moey-flex-1", 3, "showLogo", "showmoeyText", "logoUrl", "vendorUrl", "vendorUrlClick"],
                        ["moey-button", "", 1, "reverse", 3, "ngClass", "moeyTrackClick", "props", "click"],
                        [3, "name", 4, "ngIf"],
                        [3, "name"],
                        ...
                        [1, "details-snippet"],
                        ["moey-icon-button", "", 1, "small", "fl-mb-16", 3, "click"],
                    ...
                    template: function(e, o) {
                        1 & e && t.YNc(0, Jo, 15, 9, "ng-container", 0), 2 & e && t.Q6J("ngrxLet", t.rFY(1, Qo, [o.vm$, o.logo$, o.showLayout$, o.isMobileLandscape$, o.showHeader$, o.isDynamicMode$, o.showmoeyText$, o.barButtons$, o.hideFloatingDetails$, o.useBonaTranslations$, o.bonaCtaButton$]))
                    },
                    dependencies: [u.ez, u.mk, u.O5, ti.D, _t.c, ht.K, Oi, d._N, d.eJ, je.i, at.N, rt.X, $t.X9, qe, uo, mo],
                    styles: [".moey-floating-bar{display:flex;justify-content:space-between}.moey-floating-bar .info-toast{display:inline-flex;align-items:center;margin:0 auto;background-color:var(--fl-primary100);border-radius:var(--fl-border-radius);padding:var(--fl-y-padding-xs) 12px}.moey-floating-bar .info-toast moey-icon{color:var(--fl-primary);width:1.5rem;height:1.5rem}.moey-floating-bar .info-toast .moey-icon-button{padding:0;width:1.5rem;height:1.5rem}.moey-floating-bar .info-toast .moey-icon-button moey-icon{color:var(--fl-primary800);width:1.25rem;height:1.25rem}.moey-floating-bar .info-toast p{color:var(--fl-primary800);margin:0 var(--fl-x-padding-xs)}.moey-floating-bar .floating-bar-wrapper{display:flex;justify-content:space-between}.moey-floating-bar .fav-btn.fav:hover{background-color:var(--fl-primary100);border-color:var(--fl-primary100)}.moey-floating-bar .fav-btn.fav moey-icon{color:var(--fl-primary);fill:var(--fl-primary)}.moey-floating-bar .floating-bar-product{background:var(--fl-bg);border-radius:var(--fl-border-radius);padding:var(--fl-y-padding-xs);align-self:baseline;display:flex;flex:1;min-width:0}@media (orientation: portrait) and (max-width: 767px){.moey-floating-bar .floating-bar-product{flex-direction:column}}.moey-floating-bar .floating-bar-product .product-inner-details{display:flex;align-items:center;justify-content:space-between;flex:1}.moey-floating-bar .floating-bar-product .product-inner-details div{display:flex;align-items:center;max-width:calc(100% - 42px)}.moey-floating-bar .floating-bar-product .product-inner-details p{white-space:nowrap;overflow:hidden;text-overflow:ellipsis}@media (orientation: landscape){.moey-floating-bar .floating-bar-product .product-inner-details p{white-space:break-spaces}.moey-floating-bar .floating-bar-product .product-inner-details .fav{margin:0 .625rem}}@media (orientation: portrait) and (max-width: 767px){.moey-floating-bar .floating-bar-product .product-inner-details{margin-bottom:var(--fl-x-padding-xs)}}.moey-floating-bar .floating-bar-product picture{margin-right:var(--fl-x-padding-xs);width:40px;height:40px;aspect-ratio:1;border-radius:var(--fl-x-padding-xs)}.moey-floating-bar .floating-bar-product-wrapper{display:flex;flex-direction:column}.moey-floating-bar .floating-bar-company{display:inline-flex;align-self:baseline;background-color:var(--fl-bg);padding:.75rem var(--fl-x-padding-xs) .75rem var(--fl-x-padding);border-bottom-right-radius:var(--fl-border-radius-md)}.moey-floating-bar .floating-bar-company .moey-powered-by{max-width:400px}.moey-floating-bar .floating-bar-company .home{margin-right:var(--fl-x-padding)}@media (min-width: 768px){.moey-floating-bar .floating-bar-company .moey-button p{max-width:200px}}.moey-floating-bar .floating-bar-company .moey-button:nth-child(n+2){margin-left:.75rem}.moey-floating-bar .floating-buy-quote{position:fixed;top:var(--fl-y-padding);left:50%;transform:translate(-50%)}@media (min-width: 768px){.moey-floating-bar .mobile{display:none}}@media (max-width: 767px){.moey-floating-bar .tablet{display:none}}.moey-floating-bar .floating-bar-product-full-wrapper{margin-top:var(--fl-y-padding);display:flex;flex-direction:column;align-self:baseline}@media (max-width: 767px){.moey-floating-bar .floating-bar-product-full-wrapper{display:none}}.moey-floating-bar .floating-bar-product-full-wrapper .full-details-container{display:flex;flex-direction:column;position:absolute;cursor:initial}.moey-floating-bar .floating-bar-product-full-wrapper .details-snippet,.moey-floating-bar .floating-bar-product-full-wrapper .details-full{background-color:var(--fl-bg);padding:.75rem;display:flex;flex-direction:column}.moey-floating-bar .floating-bar-product-full-wrapper .details-full{width:385px;position:absolute;transition:left .5s;left:-385px;border-radius:var(--fl-border-radius-md);border:1px solid var(--fl-border-clr)}.moey-floating-bar .floating-bar-product-full-wrapper .details-full .moey-caption{color:var(--fl-fg700)}.moey-floating-bar .floating-bar-product-full-wrapper .details-full .product-ar-info{display:flex;flex-direction:column;justify-content:center}.moey-floating-bar .floating-bar-product-full-wrapper .details-full .product-qr{border-radius:var(--fl-border-radius-md);border:1px solid var(--fl-border-clr);height:152px;display:flex;justify-content:center;align-items:center}.moey-floating-bar .floating-bar-product-full-wrapper .details-full .product-qr qrcode{height:120px}.moey-floating-bar .floating-bar-product-full-wrapper .details-full .product-qr qrcode canvas{width:120px!important;height:120px!important}.moey-floating-bar .floating-bar-product-full-wrapper .details-full .close-btn{position:absolute;top:4px;right:4px;color:var(--fl-fg800)}.moey-floating-bar .floating-bar-product-full-wrapper .details-full .split-view{display:grid;grid-template-columns:152px 184px;grid-column-gap:var(--fl-x-padding);padding-top:var(--fl-y-padding)}.moey-floating-bar .floating-bar-product-full-wrapper .details-full .split-view:not(.border){padding-bottom:var(--fl-y-padding)}.moey-floating-bar .floating-bar-product-full-wrapper .details-full .split-view.border{border-top:1px solid var(--fl-border-clr);padding-top:var(--fl-y-padding)}.moey-floating-bar .floating-bar-product-full-wrapper .details-full .split-view picture{border-radius:var(--fl-border-radius)}.moey-floating-bar .floating-bar-product-full-wrapper .details-snippet{align-items:center;transition:opacity .5s;border-top-right-radius:var(--fl-border-radius-md);border-bottom-right-radius:var(--fl-border-radius-md);border-color:var(--fl-border-clr);border:1px solid var(--fl-border-clr);border-left:none}.moey-floating-bar .floating-bar-product-full-wrapper .details-snippet button{align-self:center}.moey-floating-bar .floating-bar-product-full-wrapper .details-snippet .product-photo{width:40px;height:40px}.moey-floating-bar .floating-bar-product-full-wrapper .details-snippet .product-photo picture{border-radius:var(--fl-border-radius)}.moey-floating-bar .floating-bar-product-full-wrapper .details-snippet .product-photo.epoxy{margin-top:var(--fl-y-padding)}.moey-floating-bar .floating-bar-product-full-wrapper.show .full-details-container{position:relative}.moey-floating-bar .floating-bar-product-full-wrapper.show .details-snippet{opacity:0}.moey-floating-bar .floating-bar-product-full-wrapper.show .details-full{display:flex;flex-direction:column;left:var(--fl-x-padding);min-width:385px}\n"],
                    encapsulation: 2,
                    changeDetection: 0
                }), n
            })();
            ...
            function Yo(n, l) {
                if (1 & n) {
                    ...
                    }), t._UZ(1, "moey-icon", 4), t._uU(2), t.ALo(3, "flTranslate"), t.qZA()
                }
                if (2 & n) {
                    const e = l.$implicit;
            ...
            let qo = (() => {
                ...
                return n.\u0275fac = function(e) {
                    ...
                    consts: [
                        ["moey-dialog-header", ""],
                        [1, "moey-side-menu-items"],
                        ["moey-button", "", "class", "secondary reverse", 3, "click", 4, "ngFor", "ngForOf", "ngForTrackBy"],
                        ["moey-button", "", 1, "secondary", "reverse", 3, "click"],
                        [3, "name"]
                    ],
                    template: function(e, o) {
                    ...
                    styles: ["[_nghost-%COMP%]{display:flex;flex-direction:column;width:100vw;background-color:var(--fl-bg)}[_nghost-%COMP%]   [moey-dialog-header][_ngcontent-%COMP%]{border-bottom-color:var(--fl-border-clr)}[_nghost-%COMP%]   .moey-side-menu-items[_ngcontent-%COMP%]{padding:.5rem var(--fl-x-padding) 0;display:flex;flex-direction:column}[_nghost-%COMP%]   .moey-side-menu-items[_ngcontent-%COMP%]   .moey-button[_ngcontent-%COMP%]{width:100%;justify-content:flex-end;font-weight:400;color:var(--fl-fg)}"],
                    changeDetection: 0
                }), n
            })();
            ...
            let Ko = (() => {
                    ...
                    return n.\u0275fac = function(e) {
                        ...
                        type: n,
                        selectors: [
                            ["moey-product-details-dialog"]
                        ],
                        hostAttrs: [1, "moey-product-details-dialog"],
                        standalone: !0,
                        features: [t.jDz],
                        decls: 16,
                        vars: 12,
                        consts: [
                            ...
                            [4, "ngFor", "ngForOf", "ngForTrackBy"],
                            ["moey-dialog-actions", ""],
                            ["moey-button", "", "moey-dialog-close", "", 1, "moey-button", "primary", "big", "close-btn"]
                        ],
                        template: function(e, o) {
                        ...
                        styles: [".moey-product-details-dialog{padding:var(--fl-y-padding-md);display:flex;flex-direction:column;flex:1;background-color:var(--fl-bg);border-radius:var(--fl-border-radius);max-width:360px}.moey-product-details-dialog .header{display:flex;align-items:center;justify-content:center;padding-bottom:var(--fl-y-padding-md);font-weight:600;font-size:1rem;line-height:1.25rem}.moey-product-details-dialog section{padding:0}.moey-product-details-dialog section .additional-info-element{display:flex;flex-direction:column;justify-content:flex-start;padding-bottom:var(--fl-x-padding-s)}.moey-product-details-dialog section .additional-info-element .additional-info-header{text-transform:uppercase;margin-bottom:4px;font-weight:600;font-size:.625rem;line-height:.75rem;color:var(--fl-fg)}.moey-product-details-dialog section .additional-info-element .additional-info-value{font-weight:500;font-size:.75rem;line-height:1rem;color:var(--fl-fg700)}.moey-product-details-dialog .moey-dialog-actions{padding:var(--fl-y-padding-md) 0 0;border:0}.moey-product-details-dialog .moey-dialog-actions .moey-button{width:100%}\n"],
                        encapsulation: 2,
                        changeDetection: 0
                    }), n
                })(),
            ...
            function en(n, l) {
                if (1 & n) {
                    const e = t.EpF();
                    t.ynx(0), t.TgZ(1, "moey-slider", 1), t.NdJ("valueChange", function(r) {
                        t.CHM(e);
                        const g = t.oxw();
            ...
            let ri = (() => {
                ...
                return n.\u0275fac = function(e) {
                    ...
                    type: n,
                    selectors: [
                        ["moey-rotation-button"]
                    ],
                    hostAttrs: [1, "moey-rotation-button"],
                    hostVars: 2,
                    hostBindings: function(e, o) {
                    ...
                    styles: [".moey-rotation-button{display:flex;flex-direction:row;align-items:center}.moey-rotation-button moey-slider{flex:1;margin:0 var(--fl-x-padding-s)}.moey-rotation-button moey-slider .slider-container{width:inherit;height:inherit}.moey-rotation-button moey-slider .slider-container .slider-wrapper{width:100%;height:100%}.moey-rotation-button moey-slider .slider-container .slider-wrapper .ngx-slider.vertical .ngx-slider-bar-wrapper{width:100%;margin:0;padding:0;display:flex;justify-content:center}.moey-rotation-button moey-slider .slider-container .slider-wrapper .ngx-slider.vertical .ngx-slider-pointer{left:-10px!important}.portrait{flex-direction:column}.portrait moey-slider{min-height:6.25rem;height:6.25rem;max-height:6.25rem;margin:var(--fl-x-padding-s) 0}.portrait moey-slider .ngx-slider-bar{width:4px!important}.landscape moey-slider{min-width:6.25rem;width:6.25rem;max-width:6.25rem}.landscape moey-slider .ngx-slider-bar{height:4px!important}\n"],
                    encapsulation: 2
                }), n
            })();
            ...
            function nn(n, l) {
                if (1 & n) {
                    ...
                    }), t._UZ(1, "moey-icon", 5), t._uU(2), t.ALo(3, "flTranslate"), t.qZA()
                }
                if (2 & n) {
                    const e = t.oxw(2).ngrxLet;
            ...
            function sn(n, l) {
                if (1 & n) {
                    ...
                    }), t._UZ(2, "moey-icon", 5), t._uU(3), t.ALo(4, "flTranslate"), t.qZA(), t.YNc(5, nn, 4, 4, "button", 2), t.BQk()
                }
                if (2 & n) {
                    const e = t.oxw().ngrxLet;
                    t.xp6(2), t.Q6J("name", e.showLayout ? "fl_expand" : "fl_condense"), t.xp6(1), t.hij(" ", t.lcZ(4, 3, e.showLayout ? "" : ""), " "), t.xp6(2), t.Q6J("ngIf", e.showZoom)
                }
            }
            ...
            function ln(n, l) {
                if (1 & n && (t.TgZ(0, "button", 6), t._UZ(1, "moey-icon", 7), t._uU(2), t.ALo(3, "flTranslate"), t._UZ(4, "moey-rotation-button", 8), t.qZA()), 2 & n) {
                    const e = t.oxw(2);
            ...
            let dn = (() => {
                ...
                return n.\u0275fac = function(e) {
                    ...
                    type: n,
                    selectors: [
                        ["moey-floating-actions-inline"]
                    ],
                    hostAttrs: [1, "moey-floating-actions-inline"],
                    standalone: !0,
                    features: [t.jDz],
                    decls: 1,
                    vars: 7,
                    consts: [
                        [4, "ngrxLet"],
                        [4, "ngIf"],
                        ["moey-button", "", "class", "outline reverse small moey-button", 3, "click", 4, "ngIf"],
                        ["class", "outline small moey-button rotation-button", 4, "ngIf"],
                        ["moey-button", "", 1, "outline", "reverse", "small", "moey-button", 3, "click"],
                        [3, "name"],
                        [1, "outline", "small", "moey-button", "rotation-button"],
                        ["name", "fl_refresh_o"],
                        [3, "type"]
                    ],
                    template: function(e, o) {
                    ...
                    styles: [".moey-floating-actions-inline{display:inline-flex}.moey-floating-actions-inline .moey-button{margin-right:var(--fl-x-padding)}.moey-floating-actions-inline .moey-button moey-icon{color:var(--fl-primary)}.moey-floating-actions-inline .rotation-button{padding:0 .5rem}\n"],
                    encapsulation: 2,
                    changeDetection: 0
                }), n
            })();
            ...
            function pn(n, l) {
                if (1 & n && (t.TgZ(0, "button", 10), t._UZ(1, "moey-icon", 11), t.YNc(2, hn, 3, 3, "span", 1), t._UZ(3, "moey-rotation-button", 12), t.qZA()), 2 & n) {
                    const e = t.oxw(2).ngrxLet,
                        o = t.oxw();
            ...
            function gn(n, l) {
                if (1 & n) {
                    ...
                    }), t.TgZ(1, "p", 16), t._uU(2), t.ALo(3, "flTranslate"), t.qZA(), t.TgZ(4, "button", 17), t._UZ(5, "moey-icon", 18), t.qZA()()
                }
                if (2 & n) {
                    const e = t.oxw(3);
                    t.xp6(2), t.hij(" ", t.lcZ(3, 3, "room.productDetails.header"), " "), t.xp6(2), t.Q6J("moeyTrackClick", e.trackingEvents.buttonClick)("props", t.DdM(5, ai))
                }
            }
            ...
            function mn(n, l) {
                if (1 & n) {
                    ...
                    }), t.TgZ(1, "p", 16), t._uU(2), t.ALo(3, "flTranslate"), t.qZA(), t.TgZ(4, "button", 17), t._UZ(5, "moey-icon", 20), t.qZA()()
                }
                if (2 & n) {
                    const e = t.oxw(3);
                    t.xp6(2), t.Oqu(t.lcZ(3, 3, "floatingBar.showAr")), t.xp6(2), t.Q6J("moeyTrackClick", e.trackingEvents.buttonClick)("props", t.DdM(5, ai))
                }
            }
            ...
            function bn(n, l) {
                if (1 & n) {
                    ...
                    t.TgZ(0, "div", 15), t.NdJ("click", function() {
                        ...
                        const r = t.oxw(3);
                        return t.KtG(r.toggleZoom())
                    }), t.TgZ(1, "p", 21), t._uU(2), t.ALo(3, "flTranslate"), t.qZA(), t.TgZ(4, "button", 22), t._UZ(5, "moey-icon", 14), t.qZA()()
                }
                if (2 & n) {
                    const e = t.oxw(2).ngrxLet;
            ...
            function vn(n, l) {
                ...
                if (2 & n) {
                    const e = t.oxw(2).ngrxLet;
                    t.xp6(2), t.hij(" ", t.lcZ(3, 2, e.showLayout ? "" : ""), " "), t.xp6(3), t.Q6J("name", e.showLayout ? "fl_expand" : "fl_condense")
                }
            }
            ...
            function yn(n, l) {
                1 & n && (t.ynx(0), t._UZ(1, "moey-floating-actions-inline"), t.BQk())
            }
            ...
            let On = (() => {
                    ...
                    return n.\u0275fac = function(e) {
                        ...
                        type: n,
                        selectors: [
                            ["moey-floating-actions"]
                        ],
                        hostAttrs: [1, "moey-floating-actions"],
                        inputs: {
                            inline: "inline"
                        },
                        standalone: !0,
                        ...
                        consts: [
                            ...
                            ["moey-icon-button", "", "class", "outline trigger", 3, "click", 4, "ngIf"],
                            [1, "picture-menu"],
                            ...
                            ["name", "fl_refresh_o"],
                            [3, "type"],
                            ["moey-icon-button", "", 1, "outline", "trigger", 3, "click"],
                            [3, "name"],
                            [1, "picture-menu-item-label", 3, "click"],
                            [1, "moey-caption"],
                            ["moey-icon-button", "", 1, "outline", 3, "moeyTrackClick", "props"],
                            ["name", "fl_info_o"],
                            [1, "picture-menu-item-label", "desktop-not", 3, "click"],
                            ["name", "fl_ar"],
                            [1, "moey-caption", "moey-semi-regular"],
                            ["moey-icon-button", "", 1, "outline"],
                            [1, "picture-menu-item-label"],
                            ["moey-icon-button", "", 1, "outline", 3, "click"],
                            ["name", "fl_compare_s"],
                        ...
                        styles: [".moey-floating-actions{position:absolute;top:var(--fl-y-padding);right:var(--fl-x-padding);display:flex;flex-direction:column}.moey-floating-actions .actions-backdrop{position:fixed;z-index:1;inset:0}@media (max-width: 767px){.moey-floating-actions .actions-backdrop{background-color:var(--fl-overlay)}}.moey-floating-actions .floating-actions-container{z-index:2}.moey-floating-actions .moey-icon-button.trigger{position:relative;z-index:3}.moey-floating-actions .picture-menu.visible .picture-menu-item-label p{display:inline-block}@media (max-width: 767px){.moey-floating-actions .picture-menu.visible .picture-menu-item-label:nth-child(1){top:52px}.moey-floating-actions .picture-menu.visible .picture-menu-item-label:nth-child(2){top:104px}.moey-floating-actions .picture-menu.visible .picture-menu-item-label:nth-child(3){top:156px}.moey-floating-actions .picture-menu.visible .picture-menu-item-label:nth-child(4){top:208px}.moey-floating-actions .picture-menu.visible .picture-menu-item-label:nth-child(5){top:260px}.moey-floating-actions .picture-menu.visible .picture-menu-item-label:nth-child(6){top:312px}.moey-floating-actions .picture-menu.visible .picture-menu-item-label:nth-child(7){top:364px}}@media (min-width: 768px) and (orientation: portrait){.moey-floating-actions .picture-menu.visible .picture-menu-item-label:nth-child(1){top:52px}.moey-floating-actions .picture-menu.visible .picture-menu-item-label:nth-child(2){top:104px}.moey-floating-actions .picture-menu.visible .picture-menu-item-label:nth-child(3){top:156px}.moey-floating-actions .picture-menu.visible .picture-menu-item-label:nth-child(4){top:208px}.moey-floating-actions .picture-menu.visible .picture-menu-item-label:nth-child(5){top:260px}.moey-floating-actions .picture-menu.visible .picture-menu-item-label:nth-child(6){top:312px}.moey-floating-actions .picture-menu.visible .picture-menu-item-label:nth-child(7){top:364px}}@media (min-width: 768px) and (orientation: landscape){.moey-floating-actions .picture-menu.visible .picture-menu-item-label:nth-child(1){top:-52px}.moey-floating-actions .picture-menu.visible .picture-menu-item-label:nth-child(2){top:-104px}.moey-floating-actions .picture-menu.visible .picture-menu-item-label:nth-child(3){top:-156px}.moey-floating-actions .picture-menu.visible .picture-menu-item-label:nth-child(4){top:-208px}.moey-floating-actions .picture-menu.visible .picture-menu-item-label:nth-child(5){top:-260px}.moey-floating-actions .picture-menu.visible .picture-menu-item-label:nth-child(6){top:-312px}.moey-floating-actions .picture-menu.visible .picture-menu-item-label:nth-child(7){top:-364px}}.moey-floating-actions .picture-menu .picture-menu-item-label{position:absolute;transition:all .3s ease-in-out;top:0;right:0;display:inline-flex;align-items:center;cursor:pointer}.moey-floating-actions .picture-menu .picture-menu-item-label p{color:var(--fl-bg);margin-right:var(--fl-x-padding);white-space:nowrap;display:none}@media (min-width: 768px) and (orientation: landscape){.moey-floating-actions{position:fixed;top:initial;right:initial;bottom:var(--fl-y-padding);left:var(--fl-x-padding);z-index:1}.moey-floating-actions .picture-menu-item-label p{display:inline-block}}.moey-floating-actions .rotation-button{padding:.5rem;height:initial!important;z-index:1;cursor:default}.moey-floating-actions .rotation-button moey-icon{color:var(--fl-primary);margin:0 .5rem 0 0}@media (max-width: 1023px){.moey-floating-actions .rotation-button{position:absolute}}@media (max-width: 767px){.moey-floating-actions .rotation-button{flex-direction:row}}@media (max-width: 1023px) and (orientation: portrait){.moey-floating-actions .rotation-button{top:3.25rem;width:2.5rem;flex-direction:column}.moey-floating-actions .rotation-button moey-icon{margin:0}}@media (max-width: 1023px) and (min-width: 768px) and (orientation: landscape){.moey-floating-actions .rotation-button{left:3.25rem;height:2.5rem;flex-direction:row}}@media (max-width: 767px) and (orientation: landscape){.moey-floating-actions .rotation-button{top:3.25rem;width:2.5rem;flex-direction:column}.moey-floating-actions .rotation-button moey-icon{margin:0}.moey-floating-actions .rotation-button .slider-wrapper{padding:0!important}}\n"],
                        encapsulation: 2,
                        changeDetection: 0
                    }), n
                })(),
                ...
                Pn = (() => {
                    class n {
                        constructor() {
                            this.canvasContainerCls = "moey-room-viewer-container", this.windowRef = (0, t.f3M)(Z.Kz), this.mobileBreakpoint = +Z.YF.tablet?.replace("px", "")
                        }
                        get isMobile() {
            ...
            function Mn(n, l) {
                if (1 & n && t._UZ(0, "moey-action-container", 14), 2 & n) {
                    const e = t.oxw().ngrxLet;
            ...
            function En(n, l) {
                if (1 & n && (t.TgZ(0, "div", 15), t._UZ(1, "moey-visualisation-actions", 16), t.qZA()), 2 & n) {
                    const e = t.oxw().ngrxLet,
                        o = t.oxw();
            ...
            function kn(n, l) {
                if (1 & n && (t.ynx(0), t.TgZ(1, "div", 1), t._UZ(2, "moey-floating-actions", 2), t.TgZ(3, "div", 3), t._UZ(4, "moey-floating-bar"), t.TgZ(5, "div", 4), t._UZ(6, "moey-room-viewer"), t.TgZ(7, "div", 5), t.YNc(8, Bn, 2, 1, "p", 6), t.TgZ(9, "div", 7), t._UZ(10, "moey-floating-actions", 8), t.qZA()()()(), t.TgZ(11, "div", 9, 10), t.YNc(13, Mn, 1, 1, "moey-action-container", 11), t.qZA(), t.YNc(14, En, 2, 3, "div", 12), t.qZA(), t.BQk()), 2 & n) {
                    const e = l.ngrxLet;
            ...
            let Dn = (() => {
                ...
                return n.\u0275fac = function() {
                    ...
                    hostAttrs: [1, "moey-base-room-layout"],
                    standalone: !0,
                    ...
                    consts: [
                        [4, "ngrxLet"],
                        [1, "moey-base-room"],
                        [1, "moey-mobile-floating-actions"],
                        [1, "moey-room-viewer-container"],
                        [1, "viewer-wrapper"],
                        [1, "bottom-floating-section"],
                        ["class", "moey-caption disclaimer", 4, "ngIf"],
                        [1, "floating-actions"],
                        [3, "inline"],
                        [1, "moey-room-action"],
                        ["mobileAction", ""],
                        [3, "actionButton", 4, "ngIf"],
                        ["class", "moey-room-bar", 3, "hidden-ui", 4, "ngIf"],
                        [1, "moey-caption", "disclaimer"],
                        [3, "actionButton"],
                        [1, "moey-room-bar"],
                    ...
                    styles: ['.moey-base-room{height:100dvh;position:relative;display:flex;flex-direction:column}@media (min-width: 1024px){.moey-base-room .moey-mobile-floating-actions{display:none}}.moey-base-room .moey-floating-bar{position:absolute;z-index:1;top:var(--fl-y-padding);left:var(--fl-x-padding)}@media (max-width: 767px) and (orientation: landscape){.moey-base-room .moey-floating-bar{right:var(--fl-x-padding)}}@media (min-width: 768px){.moey-base-room .moey-floating-bar{top:0;left:0}}@media (max-width: 1023px){.moey-base-room{display:grid;max-width:100vw;grid-template-areas:"viewer" "actions" "bar"}}@media (orientation: portrait) and (max-width: 1023px){.moey-base-room{grid-template-rows:1fr auto auto}}@media (orientation: landscape) and (max-width: 767px){.moey-base-room{grid-template-areas:"viewer actions" "bar actions";grid-template-columns:1fr auto;grid-template-rows:1fr}}@media (orientation: landscape) and (min-width: 768px){.moey-base-room{display:flex;flex-direction:row}}.moey-base-room .moey-room-viewer-container{position:relative;z-index:0;background-color:var(--fl-bg200);flex:1;height:100%}@media (orientation: landscape) and (max-width: 1023px){.moey-base-room .moey-room-viewer-container{grid-area:viewer}}.moey-base-room .moey-room-viewer-container .viewer-wrapper{width:100%;height:100%;position:relative}.moey-base-room .moey-room-viewer-container .viewer-wrapper .moey-room-viewer{position:absolute;inset:0}.moey-base-room .moey-room-viewer-container .bottom-floating-section{position:absolute;left:var(--fl-x-padding-xs);bottom:var(--fl-y-padding-xs)}@media (min-width: 768px){.moey-base-room .moey-room-viewer-container .bottom-floating-section{left:.75rem;bottom:.75rem}.moey-base-room .moey-room-viewer-container .bottom-floating-section .disclaimer{max-width:328px}}.moey-base-room .moey-room-viewer-container .bottom-floating-section .moey-caption.disclaimer{display:inline-flex;color:var(--fl-bg);background-color:var(--fl-overlay);border-radius:var(--fl-border-radius);padding:.25rem .5rem}@media (max-width: 767px){.moey-base-room .moey-room-viewer-container .bottom-floating-section .moey-caption.disclaimer{display:none}}.moey-base-room .moey-room-viewer-container .bottom-floating-section .floating-actions{margin-top:var(--fl-y-padding-xs)}.moey-base-room .moey-room-viewer-container .bottom-floating-section .floating-actions .moey-floating-actions{position:initial}@media (max-width: 1023px){.moey-base-room .moey-room-viewer-container .bottom-floating-section .floating-actions{display:none}}.moey-base-room .moey-room-viewer-container .disclaimer-wrapper{position:absolute;left:var(--fl-x-padding-xs);bottom:var(--fl-y-padding-xs);background-color:var(--fl-overlay);padding:.25rem .5rem;border-radius:var(--fl-border-radius)}.moey-base-room .moey-room-viewer-container .disclaimer-wrapper .moey-caption{color:var(--fl-bg)}@media (max-width: 767px) and (orientation: portrait){.moey-base-room .moey-room-viewer-container .disclaimer-wrapper{display:none}}@media (min-width: 768px) and (orientation: landscape){.moey-base-room .moey-room-viewer-container .disclaimer-wrapper{bottom:var(--fl-y-padding);left:4.5rem;max-width:32vw}}.moey-base-room .moey-room-action{display:none}@media (max-width: 767px){.moey-base-room .moey-room-action{grid-area:actions;display:block}}@media (orientation: portrait){.moey-base-room .moey-room-action{display:block}}.moey-base-room .moey-room-bar{background-color:var(--fl-bg);z-index:0}@media (orientation: landscape) and (max-width: 1023px){.moey-base-room .moey-room-bar{grid-area:bar}}@media (min-width: 768px){.moey-base-room .moey-room-bar{z-index:0}}\n'],
                    encapsulation: 2
                }), n
            })()
        },
        9111: (K, v, c) => {
            ...
            function Je(b, a) {
                if (1 & b) {
                    ...
                    }), t._UZ(2, "moey-icon", 5), t._uU(3, " reset "), t.qZA(), t.TgZ(4, "button", 6), t.NdJ("click", function() {
                        t.CHM(i);
                        const h = t.oxw();
                        return t.KtG(h.reset())
                    }), t._UZ(5, "moey-icon", 5), t.qZA(), t.BQk()
                }
            }
            let Qe = (() => {
                class b {
                ...
                return b.\u0275fac = function(i) {
                    ...
                    consts: [
                        ...
                        ["moey-button", "", 1, "outline", "reverse", "small", 3, "click"],
                        ["name", "fl_trash_o"],
                        ["moey-icon-button", "", 1, "outline", "small", 3, "click"]
                    ],
                    template: function(i, s) {
