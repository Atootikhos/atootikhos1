        ...
        7988: (T, M, a) => {
            ...
            function uo(e, r) {
                if (1 & e) {
                    ...
                    }), o._UZ(1, "moey-icon", 4), o.qZA()
                }
            }
            function ho(e, r) {
                if (1 & e) {
                    const t = o.EpF();
                    o.TgZ(0, "button", 5), o._UZ(1, "moey-icon", 6), o.TgZ(2, "input", 7), o.NdJ("change", function (i) {
                        o.CHM(t);
                        const l = o.oxw(2);
            ...
            let vo = (() => {
                ...
                return e.\u0275fac = function (t) {
                    ...
                    type: e,
                    selectors: [
                        ["moey-floating-actions-rooms"]
                    ],
                    hostAttrs: [1, "moey-floating-actions-rooms"],
                    inputs: {
                    ...
                    consts: [
                        [4, "ngrxLet"],
                        ["moey-icon-button", "", "class", "outline big", 3, "click", 4, "ngIf"],
                        ["class", "moey-icon-button primary big", 4, "ngIf"],
                        ["moey-icon-button", "", 1, "outline", "big", 3, "click"],
                        ["name", "fl_search_o"],
                        [1, "moey-icon-button", "primary", "big"],
                        ["name", "fl_camera_o"],
                        ["type", "file", 1, "moey-pointer", 3, "accept", "disabled", "change"]
                    ],
                    template: function (t, n) {
                        1 & t && o.YNc(0, _o, 3, 2, "ng-container", 0), 2 & t && o.Q6J("ngrxLet", o.VKq(1, xo, n.vm$))
                    },
                    dependencies: [c.ez, c.O5, I.c, _.K, C._N, C.eJ],
                    styles: [".moey-floating-actions-rooms{display:flex;flex-direction:column}.moey-floating-actions-rooms .moey-icon-button,.moey-floating-actions-rooms .moey-button{position:relative;margin-top:.75rem;align-self:baseline}.moey-floating-actions-rooms .moey-icon-button input[type=file],.moey-floating-actions-rooms .moey-button input[type=file]{position:absolute;opacity:0;inset:0}\n"],
                    encapsulation: 2
                }), e
            })();
            var Co = a(8590),
            ...
            function yo(e, r) {
                if (1 & e) {
                    const t = o.EpF();
                    o.TgZ(0, "button", 6), o._UZ(1, "moey-icon", 7), o._uU(2), o.ALo(3, "flTranslate"), o.TgZ(4, "input", 8), o.NdJ("change", function (i) {
                        o.CHM(t);
                        const l = o.oxw(2);
                        return o.KtG(l.photoInputUpload(i))
                    }), o.qZA()()
                ...
                if (2 & e) {
                    const t = o.oxw().ngrxLet,
                        n = o.oxw();
                    o.Q6J("disabled", t.data.uploading), o.xp6(2), o.hij(" ", o.lcZ(3, 3, "click here"), " "), o.xp6(2), o.Q6J("accept", n.validFileTypes)
                }
            }
            function To(e, r) {
            ...
            function Mo(e, r) {
                if (1 & e && (o.TgZ(0, "p", 11), o._uU(1), o.ALo(2, "flTranslate"), o.qZA(), o._UZ(3, "moey-progress-loader", 12)), 2 & e) {
                    const t = o.oxw().ngrxLet;
                    o.xp6(1), o.hij(" ", o.lcZ(2, 2, "uploading"), " "), o.xp6(2), o.Q6J("mainLabel", t.progress)
                }
            }
            function wo(e, r) {
                1 & e && o.GkF(0)
            ...
            function Bo(e, r) {
                if (1 & e) {
                    ...
                    }), o._UZ(6, "input", 26)(7, "moey-icon", 27), o.TgZ(8, "p", 11), o._uU(9), o.ALo(10, "flTranslate"), o.qZA(), o.YNc(11, No, 1, 0, "ng-container", 20), o.qZA()()
                }
                if (2 & e) {
                    const t = o.oxw().ngrxLet,
                        n = o.MAs(4),
                        i = o.MAs(2),
                        l = o.oxw();
                    o.xp6(2), o.Q6J("ngTemplateOutlet", n), o.xp6(1), o.Q6J("ngIf", !(null != t.header && t.header.customHeaderEnabled)), o.xp6(1), o.Q6J("ngIf", null == t.header ? null : t.header.customHeaderEnabled), o.xp6(2), o.Q6J("accept", l.validFileTypes), o.xp6(3), o.hij(" ", o.lcZ(10, 6, "upload.your.photo "), " "), o.xp6(2), o.Q6J("ngTemplateOutlet", i)
                }
            }
            function So(e, r) {
                1 & e && o.GkF(0)
            ...
            let Eo = (() => {
                ...
                return e.\u0275fac = function (t) {
                    ...
                    consts: [
                        ...
                        ["class", "mobile", 4, "ngIf"],
                        ["class", "full", 4, "ngIf"],
                        [1, "moey-button", "primary", "upload-btn", 3, "disabled"],
                        ["name", "fl_camera_o"],
                        ["type", "file", 1, "moey-pointer", 3, "accept", "change"],
                        [1, "rooms-upload-full-preview"],
                        ["alt", "full preview", "loading", "lazy", 3, "src"],
                        [1,"moey-subtitle moey-bold rooms-upload-title"],
                        ...
                        [1, "full"],
                        [1, "roomas-marketing-fulla"],
                        ["class", "marketing-text", 4, "ngIfa"],
                        ["moeyFileDrop", "", "overCls", "over", 1, "rooms-upload-drop-zone", 3, "statusChange"],
                        ["moeyFileDropZone", "", "type", "file", 1, "moey-pointer", 3, "accept"],
                        ["name", "fl_photo_s", 1, "drop-icon"],
                        [1, "marketing-text"],
                        [1, "moey-semi-bold", "rooms-upload-title"],
                    ...
                    styles: [".moey-room-upload{position:relative;display:flex;flex-direction:column;align-items:center;background-size:cover;background-repeat:no-repeat;border-radius:var(--fl-border-radius-md)}.moey-room-upload .rooms-upload-title{margin-bottom:1.5rem}.moey-room-upload .rooms-upload-title span{color:var(--fl-primary)}.moey-room-upload p{margin-bottom:1.5rem}.moey-room-upload .mobile{display:flex;width:100%;justify-content:space-between;padding:1.125rem 0rem;background-color:var(--fl-bg100);border-radius:var(--fl-border-radius-md)}.moey-room-upload .mobile .room-upload-marketing{display:flex;flex-direction:column;margin-right:1.875rem;padding-top:.0rem;max-width:50%}.moey-room-upload .mobile .room-upload-marketing p{margin-bottom:0rem}.moey-room-upload .mobile .room-upload-preview img{width:0px}.moey-room-upload .mobile .room-uploading-mobile{display:flex;flex-direction:column;width:inherit;align-items:center;padding:0rem 0}@media (min-width: 768px){.moey-room-upload .mobile{display:none}}.moey-room-upload .full{display:none;background-image:url('https://www.crowncrete.com.au/images/Original_transparent_cropped_Scalled.png');background-size:cover;background-repeat:no-repeat;border-radius:var(--fl-border-radius-md)}@media (min-width: 768px){.moey-room-upload .full{display:flex;width:100%;justify-content:space-between;padding:var(--fl-y-padding-md) var(--fl-x-padding-md)}}.moey-room-upload .full .rooms-marketing-fulfl{display:flex;max-width:70%}.moey-room-upload .full .marketing-text{margin:0 40px;display:flex;flex-direction:column;justify-content:center}@media (min-width: 768px){.moey-room-upload .full .rooms-upload-full-preview img{height:1px}}@media (min-width: 1px){.moey-room-upload .full .rooms-upload-full-preview img{height:0px}}.moey-room-upload .full .rooms-upload-drop-zone{border-radius:var(--fl-border-radius);border:1px dashed var(--fl-border-clr);background-color:var(--fl-bg200);width:35%;display:flex;flex-direction:column;justify-content:center;align-items:center;padding:0 30%;position:relative}.moey-room-upload .full .rooms-upload-drop-zone.over{opacity:.5}.moey-room-upload .full .rooms-upload-drop-zone p{text-align:center}.moey-room-upload .full .rooms-upload-drop-zone .drop-icon{color:var(--fl-primary);margin-bottom:24px}.moey-room-upload .full .rooms-upload-drop-zone .upload-btn{align-self:initial}.moey-room-upload .full .room-uploading-full{display:flex;flex-direction:column;flex:1 auto;align-items:center;justify-content:center}.moey-room-upload .upload-btn{position:relative;align-self:baseline}.moey-room-upload input[type=file]{position:absolute;opacity:0;inset:0}.moey-room-upload .room-upload-progress{width:100%;max-width:300px}.moey-room-upload.small .full{align-items:center;padding:var(--fl-y-padding) var(--fl-x-padding)}.moey-room-upload.small .full .rooms-upload-full-preview,.moey-room-upload.small .full .drop-icon,.moey-room-upload.small .full .marketing-text p{display:none}.moey-room-upload.small .full h4{margin-bottom:0}.moey-room-upload.small .full .rooms-upload-drop-zone{width:auto;border:none;margin:0;padding:0;background-color:transparent}.moey-room-upload.small .full .rooms-upload-drop-zone p{display:none}.moey-room-upload.small .full .rooms-upload-title{font-weight:700;font-size:0rem;line-height:0rem}\n"],
                    encapsulation: 2,
                    changeDetection: 0
                }), e
            })();
            ...
            function $o(e, r) {
                if (1 & e) {
                    ...
                    }), o.TgZ(2, "div", 4)(3, "p", 5), o._uU(4), o.ALo(5, "flTranslate"), o.qZA(), o._UZ(6, "moey-icon", 6), o.qZA(), o._UZ(7, "div", 7), o.ALo(8, "resolveImg"), o.qZA(), o.BQk()
                }
                if (2 & e) {
                    const t = r.$implicit,
                        n = r.index,
                        i = o.oxw().index,
                        l = o.oxw();
                    o.xp6(1), o.Q6J("ngStyle", l.getRoomsItemHeight(n * l.columnsNumber + i)), o.xp6(3), o.Oqu(o.lcZ(5, 5, "use")), o.xp6(3), o.Udp("background-image", "url(" + o.lcZ(8, 7, t.image) + ")"), o.Q6J("moeySkeletonLoader", l.loading)
                }
            }
            function zo(e, r) {
            ...
            let Go = (() => {
                ...
                return e.\u0275fac = function (t) {
                    ...
                    consts: [
                        ...
                        [1, "room-item", 3, "moeySkeletonLoader"]
                    ],
                    template: function (t, n) {
                        1 & t && o.YNc(0, zo, 3, 2, "ng-container", 0), 2 & t && o.Q6J("ngForOf", n.columnsIteration)
                    },
                    dependencies: [c.ez, c.sg, c.PC, Yo.xj, x.TJ, v.N, b.X, _.K],
                    styles: [".moey-rooms-mosaic{display:flex;flex-direction:row}.moey-rooms-mosaic .room-items-column{display:flex;flex-direction:column;flex:1;margin-right:1rem}.moey-rooms-mosaic .room-items-column:last-child{margin-right:0}.moey-rooms-mosaic .room-item-wrapper{cursor:pointer;margin:0 0 1rem;display:inline-block;width:100%;border-radius:var(--fl-border-radius);overflow:hidden;position:relative;z-index:3}.moey-rooms-mosaic .room-item-wrapper .room-item-overlay{display:none;position:absolute;inset:0;background-color:var(--fl-overlay);z-index:1}.moey-rooms-mosaic .room-item-wrapper .room-item-overlay p,.moey-rooms-mosaic .room-item-wrapper .room-item-overlay moey-icon{color:var(--fl-bg)}@media (hover: hover) and (pointer: fine){.moey-rooms-mosaic .room-item-wrapper:hover .room-item-overlay{display:flex;justify-content:center;align-items:center}.moey-rooms-mosaic .room-item-wrapper:hover .room-item{transform:scale(1.15);-webkit-transform:translateZ(0) scale(1.15);transition:all .2s ease-in-out}}.moey-rooms-mosaic .room-item{cursor:pointer;margin:0 0 1rem;display:inline-block;width:100%;height:100%;background-position:center;background-repeat:no-repeat;background-size:cover;border-radius:inherit}\n"],
                    encapsulation: 2,
                    changeDetection: 0
                }), e
            })();
            ...
            function Ko(e, r) {
                if (1 & e) {
                    const t = o.EpF();
                    o.TgZ(0, "moey-checkbox", 5), o.NdJ("ngModelChange", function (i) {
            ...
            let qo = (() => {
                ...
                return e.\u0275fac = function (t) {
                    ...
                    consts: [
                        ...
                        ["moey-dialog-actions", ""],
                        [1, "moey-button", "primary", "big", 3, "click"],
                        [3, "ngModel", "ngModelChange"]
                    ],
                    template: function (t, n) {
                        1 & t && (o.TgZ(0, "div", 0), o._uU(1), o.ALo(2, "flTranslate"), o.qZA(), o.TgZ(3, "section", 1), o.YNc(4, Ko, 3, 2, "moey-checkbox", 2), o.qZA(), o.TgZ(5, "div", 3)(6, "button", 4), o.NdJ("click", function () {
                            return n.confirm()
                    ...
                    styles: ["[_nghost-%COMP%]{background-color:var(--fl-bg);height:100%;display:flex;flex-direction:column}@media (min-width: 768px){[_nghost-%COMP%]{display:none}}[_nghost-%COMP%]   .moey-dialog-content[_ngcontent-%COMP%]{padding-top:var(--fl-x-padding-md);padding-bottom:var(--fl-x-padding-md)}[_nghost-%COMP%]   .moey-dialog-actions[_ngcontent-%COMP%]   button[_ngcontent-%COMP%]{width:100%}[_nghost-%COMP%]   .moey-checkbox[_ngcontent-%COMP%]{background-color:transparent;margin:0;padding:0 0 .75rem}"],
                    changeDetection: 0
                }), e
            })();
            var N = a(116),
                ...
                et = a(1945);
            function nt(e, r) {
                if (1 & e && (o.TgZ(0, "moey-radio", 7), o._UZ(1, "img", 8), o.TgZ(2, "span"), o._uU(3), o.ALo(4, "flTranslate"), o.qZA()()), 2 & e) {
                    const t = r.$implicit;
            ...
            function it(e, r) {
                if (1 & e) {
                    ...
                    }), o.YNc(1, nt, 5, 6, "moey-radio", 6), o.qZA()
                }
                if (2 & e) {
                    const t = o.oxw();
            ...
            let rt = (() => {
                ...
                return e.\u0275fac = function (t) {
                    ...
                    consts: [
                        ["moey-dialog-header", ""],
                        ["moey-dialog-content", ""],
                        ["moey-radio-group", "", 3, "ngModel", "ngModelChange", 4, "ngIf"],
                        ["moey-dialog-actions", ""],
                        [1, "moey-button", "primary", "big", "moey-w100prc", 3, "moey-dialog-close"],
                        ["moey-radio-group", "", 3, "ngModel", "ngModelChange"],
                        [3, "value", 4, "ngFor", "ngForOf", "ngForTrackBy"],
                        [3, "value"],
                        ["loading", "lazy", 1, "fl-mr-12", 3, "src", "alt"]
                    ],
                    template: function (t, n) {
                        1 & t && (o.TgZ(0, "div", 0), o._uU(1), o.ALo(2, "flTranslate"), o.qZA(), o.TgZ(3, "section", 1), o.YNc(4, it, 2, 3, "div", 2), o.qZA(), o.TgZ(5, "div", 3)(6, "button", 4), o._uU(7), o.ALo(8, "flTranslate"), o.qZA()()), 2 & t && (o.xp6(1), o.hij(" ", o.lcZ(2, 4, "changeLanguage"), "\n"), o.xp6(3), o.Q6J("ngIf", null == n.langs ? null : n.langs.length), o.xp6(2), o.Q6J("moey-dialog-close", n.currentLang), o.xp6(1), o.hij(" ", o.lcZ(8, 6, "chooseLanguage"), " "))
                    },
            ...
            function at(e, r) {
                if (1 & e) {
                    ...
                    }), o.TgZ(1, "p", 2), o._uU(2), o.qZA(), o.YNc(3, lt, 1, 0, "moey-icon", 3), o.qZA()
                }
                if (2 & e) {
                    const t = r.$implicit,
                        n = o.oxw();
                    o.ekj("selected", n.selectedMap[t.value]), o.Q6J("moeySkeletonLoader", n.loading), o.xp6(2), o.Oqu(t.label), o.xp6(1), o.Q6J("ngIf", n.showClear)
                }
            }
            let st = (() => {
                class e {
                ...
                return e.\u0275fac = function (t) {
                    ...
                    vars: 2,
                    consts: [
                        ["class", "moey-chip moey-d-inline-flex moey-align-items-center moey-pointer", 3, "selected", "moeySkeletonLoader", "click", 4, "ngFor", "ngForOf", "ngForTrackBy"],
                        [1, "moey-chip", "moey-d-inline-flex", "moey-align-items-center", "moey-pointer", 3, "moeySkeletonLoader", "click"],
                        [1, "moey-caption", "moey-semi-regular", "moey-pointer"],
            ...
            let gt = (() => {
                ...
                return e.\u0275fac = function (t) {
                    ...
                    consts: [
                        ...
                        ["moey-button", "", 1, "outline", "reverse", 3, "click"],
                        ["name", "fl_search_o"],
                        [4, "ngIf"],
                    ...
                    template: function (t, n) {
                        1 & t && (o.TgZ(0, "div", 0)(1, "p", 1), o._uU(2), o.ALo(3, "flTranslate"), o.qZA(), o.TgZ(4, "p", 2), o._uU(5), o.ALo(6, "flTranslate"), o.qZA()(), o.TgZ(7, "div", 3)(8, "button", 4), o.NdJ("click", function () {
                            return n.openDialog()
                        }), o._UZ(9, "moey-icon", 5), o.YNc(10, ct, 3, 3, "ng-container", 6), o.YNc(11, dt, 3, 6, "ng-container", 6), o.qZA(), o.TgZ(12, "moey-chips", 7), o.NdJ("selectionChanged", function (l) {
                            return n.selectionChanged.emit(l)
                        }), o.qZA()()), 2 & t && (o.xp6(2), o.Oqu(o.lcZ(3, 8, "You can use our Samples down below")), o.xp6(3), o.Oqu(o.lcZ(6, 10, "select a room")), o.xp6(5), o.Q6J("ngIf", !n.selection.length), o.xp6(1), o.Q6J("ngIf", !!n.selection.length), o.xp6(1), o.Q6J("loading", !!n.loading)("items", n.items || o.DdM(12, pt))("selected", n.selection)("multi", !0))
                    },
                    dependencies: [c.ez, c.O5, I.c, _.K, st, v.N, b.X],
                    styles: [".moey-room-filters{display:flex;justify-content:space-between}@media (min-width: 768px){.moey-room-filters .room-filters-text{text-align:center}}.moey-room-filters .room-filters-container .moey-button{width:164px;position:relative}@media (max-width: 767px){.moey-room-filters moey-chips{display:none}}@media (min-width: 768px){.moey-room-filters{flex-direction:column}.moey-room-filters .room-filters-container{margin-top:16px}.moey-room-filters .room-filters-container .moey-button{display:none}}\n"],
                    encapsulation: 2,
                    changeDetection: 0
                }), e
            })();
            ...
            function ut(e, r) {
                if (1 & e && o._UZ(0, "moey-icon", 26), 2 & e) {
            ...
            function _t(e, r) {
                if (1 & e) {
                    ...
                    }), o.YNc(2, ut, 1, 1, "moey-icon", 24), o.YNc(3, ht, 3, 3, "ng-container", 25), o.qZA()()
                }
                if (2 & e) {
                    const t = o.oxw(2).ngrxLet;
            ...
            function bt(e, r) {
                if (1 & e) {
                    const t = o.EpF();
                    o.TgZ(0, "div", 29)(1, "button", 30), o.NdJ("cjick", function () {
                        o.CHM(t);
                        const i = o.oxw(2).ngrxLet,
                            l = o.oxw();
                        return o.KtG(l.ctaAction(i.data.ctaButton))
                    }), o.YNc(2, vt, 1, 1, "moey-icon", 24), o.YNc(3, Ct, 3, 3, "ng-container", 25), o.qZA()()
                }
                if (2 & e) {
                    const t = o.oxw(2).ngrxLet;
                    o.xp6(2), o.Q6J("ngIf", null == t.data || null == t.data.ctaButton ? null : t.data.ctaButton.icon), o.xp6(1), o.Q6J("ngIf", null == t.data.ctaButton ? null : t.data.ctaButton.label)
            ...
            function yt(e, r) {
                if (1 & e) {
                    ...
                    }), o.qZA()(), o.TgZ(5, "div", 15), o.YNc(6, _t, 4, 2, "div", 16), o.TgZ(7, "div", 17), o.YNc(8, xt, 4, 5, "button", 18), o.qZA()()(), o.YNc(9, bt, 4, 2, "div", 19), o.TgZ(10, "div", 20), o._UZ(11, "moey-room-upload", 21), o.qZA()()()
                }
                if (2 & e) {
                    const t = o.oxw().ngrxLet,
                        n = o.oxw();
                    o.ekj("cta", t.data.ctaButton), o.xp6(4), o.ekj("moey-pointer", !!t.data.vendorUrl), o.Q6J("src", t.data.logo || n.moeyLogo, o.LSH), o.xp6(2), o.Q6J("ngIf", null == t.data || null == t.data.ctaButton ? null : t.data.ctaButton.visible), o.xp6(2), o.Q6J("ngIf", t.showLangs), o.xp6(1), o.Q6J("ngIf", null == t.data || null == t.data.ctaButton ? null : t.data.ctaButton.visible), o.xp6(1), o.ekj("floating", !t.data.uploadVisible)
                }
            }
            function Tt(e, r) {
                if (1 & e) {
                    const t = o.EpF();
                    o.TgZ(0, "div", 31)(1, "moey-rooms-filters", 32), o.NdJ("filterDialogClick", function () {
                        o.CHM(t);
                        const i = o.oxw(2);
            ...
            function wt(e, r) {
                if (1 & e) {
                    const t = o.EpF();
                    o.ynx(0), o.YNc(1, yt, 12, 10, "nav", 1), o.TgZ(2, "section", 2, 3)(4, "moey-room-upload", 4), o.NdJ("visible", function (i) {
                        o.CHM(t);
                        const l = o.oxw();
                        return o.KtG(l.uploadVisibilityChange(i))
                    }), o.qZA(), o.TgZ(5, "moey-floating-actions-rooms", 5), o.NdJ("openFiltersDialog", function () {
                        o.CHM(t);
                        const i = o.oxw();
                        return o.KtG(i.openFiltersDialog())
                    }), o.qZA(), o.TgZ(6, "div", 6), o.YNc(7, Tt, 2, 5, "div", 7), o.TgZ(8, "div", 8)(9, "div", 9)(10, "moey-rooms-mosaic", 10), o.NdJ("roomSelected", function (i) {
                        o.CHM(t);
                        const l = o.oxw();
            ...
            let Ft = (() => {
                class e {
                    constructor() {
                        this.store = (0, o.f3M)(E), this.vm$ = this.store.vm$, this.showLangs$ = this.store.showLangs$, this.rooms$ = this.store.rooms$, this.moeyLogo = m.Ff.moeyLogo, this.roomsItemAvailableHeights = ["234px", "136px", "164px", "234px", "234px"], this.roomsItemHeights = []
                    }
                    ngAfterViewInit() {
                ...
                return e.\u0275fac = function (t) {
                    ...
                    hostAttrs: [1, "moey-base-rooms-layout"],
                    standalone: !0,
                    ...
                    consts: [
                        [4, "ngrxLet"],
                        [3, "cta", 4, "ngIf"],
                        [1, "moey-rooms-container"],
                        ["roomsContainer", ""],
                        ["moeyVisibilityChange", "", 3, "moeySkeletonLoader", "visible"],
                        [3, "showFilters", "openFiltersDialog"],
                        [1, "rooms-content"],
                        ["class", "rooms-filters", 3, "floating", 4, "ngIf"],
                        [1, "moey-rooms-wrapper"],
                        [1, "mosaic-wrapper"],
                        ...
                        [1, "moey-lang-wrapper"],
                        ["moey-button", "", "class", "outline small fl-ml-16", 3, "click", 4, "ngIf"],
                        ...
                        [4, "ngIf"],
                        [3, "name"],
                        ["moey-button", "", 1, "outline", "small", "fl-ml-16", 3, "click"],
                        [1, "fl-mr-8", 3, "src", "alt"],
                        [1, "rooms-cta-wrapper"],
                        ["moey-button", "", 1, "outline", "reverse", 3, "click"],
                        [1, "rooms-filters"],
